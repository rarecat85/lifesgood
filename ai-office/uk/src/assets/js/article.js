...
function setupFloatingBannerWithScrollTrigger() {
  ...
  function updateFloatingBanner() {
    ...
    const floatingBannerData = {
      gram: {
        imgSrc: "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgeuk/ai-office/images/lifes-good-campaign-2025-live-human-lgcom-ai-office-img-floating-banner-img-gram.png",
        title: '17" LG gram AI Laptop, 16GB RAM, Intel® Core™ Ultra Processor, gram Hybrid AI, Obsidian Black',
        link: 'https://www.lg.com/uk/laptops/gram/17z90tl-g-au78a1/'
      },
      cassette: {
        imgSrc: "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgeuk/ai-office/images/lifes-good-campaign-2025-live-human-lgcom-ai-office-img-floating-banner-img-cassette.png",
        title: 'Round Cassette, Indoor Unit, 24kBTU',
        link: 'https://www.lg.com/uk/business/hvac/vrf/vrf-indoor-units/arnu24gtya4/?srsltid=AfmBOorwTEHESILroEkpYTUgVfmBdE19OXz00wW36j_MlRfRzhu1FDVD'
      }
    };
