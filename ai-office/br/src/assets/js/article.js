...
function setupFloatingBannerWithScrollTrigger() {
  ...
  function updateFloatingBanner() {
    ...
    const floatingBannerData = {
      cassette: {
        imgSrc: "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgebr/ai-office/images/lifes-good-campaign-2025-live-human-lgcom-ai-ofiice-img-floating-banner-img-cassette.png",
        title: 'Ar Condicionado LG Round Cassete 60.000 BTU/h 220V AT-W60GYLP1',
        link: 'https://www.lg.com/br/ar-condicionado-comercial-leve/at-w60gylp1/'
      }
    };
