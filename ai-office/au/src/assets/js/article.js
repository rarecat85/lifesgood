...
function setupFloatingBannerWithScrollTrigger() {
  ...
  function updateFloatingBanner() {
    ...
    const floatingBannerData = {
      gram: {
        imgSrc: "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgeau/ai-office/images/lifes-good-campaign-2025-live-human-lgcom-ai-ofiice-img-floating-banner-img-gram.png",
        title: 'LG Gram Model',
        link: 'https://www.lg.com/au/laptops/gram/16z90tl-g-au88a/'
      }
    };
