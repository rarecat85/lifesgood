document.addEventListener("DOMContentLoaded", function () {
  ...
  function setHeroVideo() {
    ...
    const newVideoSrc = isDesktop
      ? "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/videos/lifes-good-campaign-2025-live-human-lgcom-gate-video-hero-kv-desktop.mp4"
      : "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/videos/lifes-good-campaign-2025-live-human-lgcom-gate-video-hero-kv-mobile.mp4";
    const newposterSrc = isDesktop
      ? "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/lifes-good-campaign-2025-live-human-lgcom-gate-img-main-kv-desktop.png"
      : "/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/lifes-good-campaign-2025-live-human-lgcom-gate-img-main-kv-mobile.png";

    // 현재 영상이 변경된 경우에만 업데이트
    if (currentVideoSrc !== newVideoSrc) {
      heroVideoBx.innerHTML = `
        <video autoplay muted playsinline loop aria-label='Un homme et une femme sont allongés sur le canapé du salon, tandis que le téléviseur de LG afficheune chaîne de cuisine. Une fois la femme endormie, l’homme parle et dit « Allô LG » et demande de faire jouer le match de soccer, et le téléviseur passe de la chaîne de cuisine à celle du match.' poster="${newposterSrc}">
  ...
  ScrollTrigger.matchMedia({
    ...
    "(min-width: 1440px)": function() {
      ...
      redPoint.setAttribute("src","/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/lifes-good-campaign-2025-live-human-lgcom-gate-img-red-point.svg");
      ...
      const heroVisual = gsap.timeline({
        scrollTrigger: {
          ...
          onLeave: function() {
            ...
            redPoint.setAttribute("src","/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/lifes-good-campaign-2025-live-human-lgcom-gate-img-ai-symbol.gif");
          },
  ...
  function updateContentBoxes() {
    contentBoxes.forEach(function (box, index) {
      ...
      if (window.innerWidth > 1025) {
        videoHTML = `
          <video muted playsinline loop poster="/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/${imgName}-desktop.png" aria-label="${altName}">
            <source src="/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/videos/${videoName}-desktop.mp4">
          </video>
          <button type="button" class="play-btn" role="button" tabindex="0" aria-pressed="false"></button>
        `;
      } else {
        videoHTML = `
          <video autoplay muted playsinline loop poster="/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/images/${imgName}-mobile.png" aria-label="${altName}">
            <source src="/content/dam/master-2/hq_gmg/brand-platform/life's-good-campaign/2025/live-human/lgcom/lgefr/gate/videos/${videoName}-mobile.mp4">
          </video>
          <button type="button" class="play-btn" role="button" tabindex="0" aria-pressed="false"></button>
        `;
      }
  ...
  popShowBtn.addEventListener("click", function () {
    ...
    // iframe의 src 속성 설정
    iframe.innerHTML = `<iframe src="https://www.youtube.com/embed/${youtubeId}?mute=1&enablejsapi=1" enablejsapi="1" title="LG VS Company : CES 2025 Teaser I LG​" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`;
    // 팝업 활성화
