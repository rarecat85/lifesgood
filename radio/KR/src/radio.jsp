  ...
  <div class="radio-container">
    ...
    <section class="parallax-container">
      <div class="parallax-txt-bx">
        <div class="parallax-txt-bx-logo" role="img" aria-label="캠페인 로고" data-tp="label">
        ...
        <h2 class="parallax-txt-bx-title heading" data-tp="copy">소중한 사람을 위한 노래를 만들어<br> 선물해 보세요</h2>
      ...
      <div class="parallax-item-bx" role="img" aria-label="광활한 바다와 눈 덮인 산이 보이는 곳에서 붉은색 등산복을 입고 있는 여자가 서있습니다."
        data-tp="label">
      ...
      <div class="scroll-move" role="img" aria-label="Scroll down" data-tp="label">
        <span data-tp="copy">Scroll down</span>
        <svg aria-hidden="true" width="34" height="63" viewBox="0 0 34 63" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <rect x="1" y="1" width="32" height="48" rx="16" stroke="white" stroke-width="2"></rect>
          <path d="M23.0703 55.9531L16.9989 61.9055L10.9275 55.9531" stroke="white" stroke-width="1.5"
            stroke-linecap="square"></path>
          <ellipse cx="16.9989" cy="36.9044" rx="2.42857" ry="2.38095" fill="white"></ellipse>
        </svg>
      </div>
    </section>
    <!-- E : parallax -->
    ...
    <section class="main-video">
      <div class="video-bx">
        <div class="player-wrapper">
          <div id="youtube-player" aria-label="이 영상 콘텐츠는 LG전자 YouTube 채널의 LG Radio Optimism입니다." data-tp="label"></div>
        </div>
      </div>
    </section>
    <section class="overview">
      <div class="inner">
        <div class="overview-heading">
          <p class="overview-heading-title heading" data-tp="copy">우리는 매일 스크롤하고, 댓글을 달고, ‘좋아요’를 누릅니다.<br>
            <span class="radio-highlight">하지만 우리는 서로 의미 있게 연결되어 있을까요? </span> <br>
            지금 우리에게 필요한 건, 마음과 마음으로 연결되는 경험인지도 모릅니다.</p>
    ...
    <section class="banner">
        ...
        <div class="inner">
          <div class="banner-main-area">
            ...
            <h2 class="banner-main-area-title heading">
              <div class="top">
                <p class="heading" data-tp="copy">우리들의 추억이 담긴 리스트</p>
              </div>
            </h2>
            ...
            <a href="https://youtu.be/7qqMgNcNzxM?si=oymrMo9iCAw7IGWL" class="banner-main-area-startbtn-fixed banner-main-area-startbtn-base"
              data-tp="link">
              <p data-tp="copy">좋았던 순간들을 들어보세요</p>
            ...
            <a href="https://youtu.be/7qqMgNcNzxM?si=oymrMo9iCAw7IGWL" class="banner-main-area-startbtn banner-main-area-startbtn-base" data-tp="link">
              <p data-tp="copy">좋았던 순간들을 들어보세요</p>
              <div class="blendbx" aria-hidden="true">
                <div class="blendbx-blend-1 blend"></div>
                <div class="blendbx-blend-2 blend"></div>
      ...
      <div class="banner-disclaimer-wrapper">
        <ul class="banner-disclaimer-wrapper-list">
          <li class="banner-disclaimer-wrapper-item" data-tp="copy">*일부 콘텐츠는 설명 목적을 위해 AI로 생성되었습니다.</li>
          <li class="banner-disclaimer-wrapper-item" data-tp="copy">*지원되는 언어는 국가 또는 지역에 따라 다를 수 있습니다.</li>
        </ul>
      </div>
    </section>
    <!-- E : Banner -->
