...
<head>
  ...
  <meta name="Keywords"
    content="LG Radio Optimism, Life’s Good music campaign, LG campaign 2025, AI music generator, ai music maker, AI song creator, create music with AI, AI music composer, how to create music with ai, AI music creation">
  <meta name="Description"
    content="Make your own song for someone special. Pick your vibe, share your story, and let LG Radio Optimism turn it into music. Join the 24/7 Dedication Station.">
  ...
  <div class="radio-container">
    ...
    <section class="parallax-container">
        ...
        <div class="parallax-txt-bx-logo" role="img" aria-label="Radio Optimism campaign logo">
          <div class="parallax-txt-bx-logo-txt">
            <picture>
              ...
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-logo-mobile.png"
                alt="RADIO OPTIMISM">
            </picture>
          </div>
      ...
      <div class="parallax-item-bx" role="img"
        aria-label="A woman wearing a red hiking jacket is standing in a place where the vast ocean and snow-covered mountains can be seen.">
        <div class="parallax-bg">
          <picture>
            ...
            <source
              srcset="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-bg-mobile.jpg"
              media="(max-width: 768px)">
            <img
              src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-bg-mobile.jpg"
              alt="parallax-bg">
          </picture>
        </div>
        <div class="parallax-item parallax-item-01">
          <picture>
            ...
            <source
              ...
              media="(max-width: 768px)">
            <img
              src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-item-01-mobile.png"
        ...
        <div class="parallax-item parallax-item-02">
          <picture>
            ...
            <source
              ...
              media="(max-width: 768px)">
            <img
              src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-item-02-mobile.png"
        ...
        <div class="parallax-item parallax-item-03">
          <picture>
            ...
            <source
              ...
              media="(max-width: 768px)">
            <img
              src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-parallax-item-03-mobile.png"
      ...
      <div class="video-bx">
        <div class="player-wrapper">
          <div id="youtube-player"
            aria-label="This is video content from LG Radio Optimism on LG Electronics YouTube channel."></div>
        </div>
      </div>
    </section>
        ...
        <div class="overview-heading">
          ...
          <div class="overview-heading-img"
            ...
            <div class="overview-heading-motion-imgs">
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-overview-heart-icon.png"
                alt="" class="motion-icon heart-icon" />
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-overview-smile-icon.png"
                alt="" class="motion-icon smile-icon" />
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-overview-img-icon.png"
                alt="" class="motion-icon img-icon" />
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-overview-like-icon.png"
        ...
        <div class="overview-cont-box">
          ...
          <div class="overview-cont">
            <div class="overview-cont-img">
              ...
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-overview-heart-tower.png"
            ...
            <p class="overview-cont-txt">
              ...
              and the moment you receive one from someone special, that's when a real connection lets us truly experience
              Life's Good.
            </p>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-01" muted playsinline preload="metadata" poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-01.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-01.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-01" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-01" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Shop.with.caroline</strong>
                <span data-tp="copy">@Shop.with.caroline</span>
              </h3>
              <a href="https://www.instagram.com/reel/DMJixNYvFMb/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA%3D%3D" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 01-->
          <!-- S : slide item 02-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-02" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-02.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-02.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-02" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-02" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Jasmine Luv-Barrett</strong>
                <span data-tp="copy">@luv_jjp</span>
              </h3>
              <a href="https://www.instagram.com/reel/DL-g3BtvA61/?igsh=dmk0cnR2MTY5dW10" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 02-->
          <!-- S : slide item 03-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-03" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-03.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-03.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-03" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-03" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Sara Karrit</strong>
                <span data-tp="copy">@afrobysara</span>
              </h3>
              <a href="https://www.tiktok.com/@afrobysara/video/7525846897664298247?is_from_webapp=1&web_id=7458183843036661279" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 03-->
          <!-- S : slide item 04-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-04" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-04.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-04.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-04" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-04" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Ben and Zara</strong>
                <span data-tp="copy">@ben.and.zara</span>
              </h3>
              <a href="https://www.instagram.com/reel/DL6_AlduXO1/?igsh=MWo2N2Y0eWdhZXNlMQ%3D%3D" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 04-->
          <!-- S : slide item 05-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-05" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-05.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-05.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-05" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-05" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Shivam Sharma</strong>
                <span data-tp="copy">@shivoryx</span>
              </h3>
              <a href="https://www.instagram.com/reel/DL1r0N6Sdo-/?igsh=M3RnMWg1OWV1d2U5" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 05-->
          <!-- S : slide item 06-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-06" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-06.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-06.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-06" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-06" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Areezs Gandhi</strong>
                <span data-tp="copy">@iplixmedia</span>
              </h3>
              <a href="https://www.instagram.com/reel/DL97FNby-8i/?igsh=MTYxMjV5dndocmZucA%3D%3D" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 06-->
          <!-- S : slide item 07-->
          <div class="swiper-slide">
            <div class="influence-content-bx">
              <video id="influence-video-07" muted playsinline poster="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-thumb-07.jpg" aria-label="Optimism life with LG campaign video">
                <source src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-influence-07.mp4" type="video/mp4">
              </video>
              <button class="influence-content-bx-play-btn" aria-label="pause video" aria-controls="influence-video-07" aria-pressed="true">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-slide-pause.svg" alt="pause video">
              </button>
              <button class="influence-content-bx-sound-btn" aria-label="sound on" aria-controls="influence-video-07" aria-pressed="false">
                <img src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-influence-unmute-icon.svg" alt="sound on">
              </button>
            </div>
            <div class="influence-txt-bx">
              <h3 class="influence-txt-bx-title">
                <strong data-tp="copy">Tarini Shah</strong>
                <span data-tp="copy">@bigbangsocl</span>
              </h3>
              <a href="https://www.instagram.com/reel/DL-B8gftJlM/?igsh=d2gwYXZheDZzZDVu" class="influence-txt-bx-btn" data-tp="link copy">Learn more</a>
            </div>
          </div>
          <!-- E : slide item 07-->
        </div>
            ...
            <div class="swiper-slide">
              <div class="how-to-video-bx responsive-video"
                ...
                <video muted playsinline aria-label="Step 1 video from the How to make your song.">
                  <source
                    src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-how-to-step01-mobile.mp4"
                    type="video/mp4">
                </video>
              ...
              <div class="how-to-txt-bx">
                <h3 class="how-to-txt-bx-title heading">
                  <span class="how-to-txt-bx-title-num">
                    <img
                      src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-how-to-step-num-01.svg"
                      alt="1">
                  </span>
                  Step into Radio Optimism.
                </h3>
                <p class="how-to-txt-bx-txt">Tap 'Let's Make a Hit' to join and begin your story. <br>Choose your
                  preferred language to get started.</p>
              </div>
            </div>
            <!-- E : slide item 01-->
            <!-- S : slide item 02-->
            <div class="swiper-slide">
              <div class="how-to-video-bx responsive-video"
                ...
                <video muted playsinline aria-label="Step 2 video from the How to make your song.">
                  <source
                    src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-how-to-step02-mobile.mp4"
                    type="video/mp4">
                </video>
                <button class="how-to-video-control-btn pause" aria-label="pause" aria-live="polite">
                  <svg class="progress-circle" width="100%" height="100%" viewBox="0 0 100 100">
              ...
              <div class="how-to-txt-bx">
                <h3 class="how-to-txt-bx-title heading">
                  <span class="how-to-txt-bx-title-num">
                    <img
                      src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-how-to-step-num-02.svg"
                      alt="2">
                  </span>
                  Tell your story.
                </h3>
                <p class="how-to-txt-bx-txt">Who are you, and who's this track for? <br>
                  The more you share — a memory, a moment, or something only you two know — <br> the better your lyrics
                  will be. Once you're done, we'll turn it into a track and custom cover art.</p>
              </div>
            </div>
            <!-- E : slide item 02-->
            <!-- S : slide item 03-->
            <div class="swiper-slide">
              <div class="how-to-video-bx responsive-video"
                ...
                <video muted playsinline aria-label="Step 3 video from the How to make your song.">
                  <source
                    src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-how-to-step03-mobile.mp4"
                    type="video/mp4">
                </video>
                <button class="how-to-video-control-btn pause" aria-label="pause" aria-live="polite">
                  <svg class="progress-circle" width="100%" height="100%" viewBox="0 0 100 100">
              ...
              <div class="how-to-txt-bx">
                <h3 class="how-to-txt-bx-title heading">
                  <span class="how-to-txt-bx-title-num">
                    <img
                      src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-how-to-step-num-03.svg"
                      alt="3">
                  </span>
                  Pick your vibe.
                </h3>
                <p class="how-to-txt-bx-txt">Time to shape the sound. Choose a genre — from hip-hop to K-pop — <br>and
                  pick a vibe that matches your story.</p>
              </div>
            </div>
            <!-- E : slide item 03-->
            <!-- S : slide item 04-->
            <div class="swiper-slide">
              <div class="how-to-video-bx responsive-video"
                ...
                <video muted playsinline aria-label="Step 4 video from the How to make your song.">
                  <source
                    src="/ae/lifesgood/assets/videos/lifes-good-campaign-2025-radio-optimism-lgcom-videos-how-to-step04-mobile.mp4"
                    type="video/mp4">
                </video>
                <button class="how-to-video-control-btn pause" aria-label="pause" aria-live="polite">
                  <svg class="progress-circle" width="100%" height="100%" viewBox="0 0 100 100">
              ...
              <div class="how-to-txt-bx">
                <h3 class="how-to-txt-bx-title heading">
                  <span class="how-to-txt-bx-title-num">
                    <img
                      src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-how-to-step-num-04.svg"
                      alt="4">
                  </span>
                  Your track is ready!
                </h3>
    ...
    <section class="banner">
      <div class="banner-wrapper">
        <div class="banner-imgbx-1">
          <img
            src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-banner-left-desktop.png"
        ...
        <div class="inner">
          <div class="banner-main-area">
            <div class="banner-main-area-imgbx">
              <img
                src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-banner-optimism-logo.gif"
            ...
            <a href="https://radiooptimism.lg.com/en?referrer_locale=ae&referrer_site=lifesgood"
              class="banner-main-area-startbtn-fixed banner-main-area-startbtn-base">
            ...
            <a href="https://radiooptimism.lg.com/en?referrer_locale=ae&referrer_site=lifesgood"
              class="banner-main-area-startbtn banner-main-area-startbtn-base">
              <p>Make your song now</p>
              <div class="blendbx" aria-hidden="true">
                <div class="blendbx-blend-1 blend"></div>
                <div class="blendbx-blend-2 blend"></div>
        ...
        <div class="banner-imgbx-2">
          <picture>
            <source
              ...
              media="(min-width: 769px)">
            <source
              srcset="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-banner-mobile.png"
              media="(max-width: 768px)">
            <img
              src="/ae/lifesgood/assets/images/lifes-good-campaign-2025-radio-optimism-lgcom-images-banner-mobile.png"
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" role="group" aria-roledescription="stories slide">
              ...
              <div class="txt-bx">
                ...
                <a href="https://www.lg.com/ae/lifesgood/product-story-washtower" class="white-btn">Learn More</a>
              </div>
            </div>
          </div>
