...
<head>
    ...
    <title>LG Affectionate Intelligence | LG AFRICA</title>
    ...
    <meta property="og:title" content="LG Affectionate Intelligence | LG AFRICA"/>
    <meta property="og:url" content="https://www.lg.com/africa/lg-ai">
      ...
      <div class="gate-container">
            ...
            <div class="tab-container" role="tablist">
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <div class="video-bx responsive-video" 
                      ...
                      >
                      <span id="benefit01-banner-video-description" class="a11y-text" data-tp="copy">A man and a woman are on the sofa, watching a soccer broadcast on an LG TV in the living room. The scene transitions, and the man and woman are hugging. The camera focuses on the LG XBOOM next to them.</span>
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/tvs/lg-oled83c56la" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products01.png" alt="LG OLED evo AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/oled-tvs" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products02.png" alt="LG OLED AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/qned-tvs" data-tp="link">
                          <div class="img-bx">
                      ...
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/nanocell-tv" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products04.png" alt="LG Ultra HD AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/audio/lg-xboom-bounce-portable-speaker" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products05.png" alt="LG xboom AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden>
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI senses your needs and presents solutions to make your life flow effortlessly to your rhythm.</h2>
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" 
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/washing-machines/lg-wt1310rh" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products01.png" alt="LG WashTower AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/washing-machines/lg-f0l9dgp2s" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products02.png" alt="LG Washing Machine AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/africa/refrigerators/lg-gc-x24ffcab" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products04.png" alt="LG InstaView AI product front view" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Learn More</span>
                        </a>
                      </li>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden>
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI cares for you, your space, and the planet to make your life well-cared, just as you desire.</h2>
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" 
                      ...
                      <span id="benefit03-banner-video-description" class="a11y-text" data-tp="copy">A man walks into the office holding a dog leash. A man in the driver's seat looks sad as LG AI shows him a family photo. The car display is shown in a close-up as LG AI pulls up a map and revisits a memory.</span>
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI product front view" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <h2 class="tab-panel-title" data-tp="copy">
                      <img src="./lg-ai/assets/image/ai-product-category-tv-eyebrow-logo-desktop.svg" alt="LG AI TV" class="eyebrow-logo" loading="lazy" data-tp="alt">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">
                          Meet the next generation of<br>
                          LG AI TV
                        </h3>
                        <a href="https://www.lg.com/africa/tvs/ai-tv" class="white-btn" data-tp="copy link">Learn More</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                      ...
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature01.png" alt="On an LG OLED TV screen is the webOS 25 home page filled with apps and entertainment content. By the TV is the LG AI Magic Remote, the AI button is highlighted as if activated by the user's voice. A speech bubble is beside it, 'suggest a movie I'll like'" data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Voice ID</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature02.png" alt="LG OLED TV screen showing how AI Search works. A small chat window is open showing how the user asked for what sports games are available. AI search responded via chat and by showing thumbnails of different available content. There is also a prompt to ask Microsoft Copilot." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Search</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature03.png" alt="The LG AI Magic Remote in use. Shortly pressing the AI button activates the AI Assistant on the OLED TV screen, which then suggests keywords." data-tp="alt">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature05.png" alt="Woman singing into microphone with headphones, highlighted by LG α11 AI Processor sound enhancement" data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Picture/Sound Wizard</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature06.png" alt="Two connected scenes with LG AI Magic Remote in front of a TV—first showing a sci-fi scene, second showing a home screen with personalized content" data-tp="alt">
                            </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
                  <div class="tab-panel-inner">
                    <!-- S : tab-panel-title -->
                    <h2 class="tab-panel-title" data-tp="copy">
                      <img src="./lg-ai/assets/image/ai-product-category-audio-eyebrow-logo-desktop.svg" alt="LG AI Audio" class="eyebrow-logo" loading="lazy" data-tp="alt">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        ...
                        <a href="https://www.lg.com/africa/audio/lg-xboom-bounce-portable-speaker" class="white-btn" data-tp="copy link">Learn More</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-feature03.png" alt="LG XBOOM speaker placed on a table in a red-toned room with grid-patterned walls and modern furniture" data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*This product is not available yet.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
                  <div class="tab-panel-inner">
                    <!-- S : tab-panel-title -->
                    <h2 class="tab-panel-title" data-tp="copy">
                      <img src="./lg-ai/assets/image/ai-product-category-appliances-eyebrow-logo-desktop.svg" alt="LG AI Appliances" class="eyebrow-logo" loading="lazy" data-tp="alt">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-appliances-banner-mobile.png" alt="LG built-in stacked washer and dryer in a modern laundry room with wood cabinetry and bench seating" loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-appliances-feature01.png" alt="Hand adjusting AI Wash cycle on LG washing machine using smart control dial" data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*This product will be released gradually in select countries.</li>
                      <li data-tp="copy">**AI sensing is activated when the load is under 6kg.</li>
                      <li data-tp="copy">***AI Wash should only be used with similar fabric types [not all fabrics are detected] and suitable detergent.</li>
                      <li data-tp="copy">****AI Dry is only available for loads under 5kg with fabrics of the same moisture absorption levels.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
                  <div class="tab-panel-inner">
                    <!-- S : tab-panel-title -->
                    <h2 class="tab-panel-title" data-tp="copy">
                      <img src="./lg-ai/assets/image/ai-product-category-air-conditioning-eyebrow-logo-desktop.svg" alt="LG AI Air Conditioning" class="eyebrow-logo" loading="lazy" data-tp="alt">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-banner-mobile.png" alt="The LG DUAL Inverter air conditioner cools a modern living room, where a woman is sitting on the sofa, powered by ThinQ AI technology." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title text-black" data-tp="copy">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature01.png" alt="Woman relaxing in a smart living room while LG AI Air conditioner automatically adjusts temperature, airflow, and humidity" data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Air</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature02.png" alt="Smartphone interface showing energy consumption graph in front of LG air conditioner, highlighting AI kW Manager for efficient power monitoring" data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*The AI Air can be operated via remote control and ThinQ.</li>
                      <li data-tp="copy">**The AI Air is available in both cooling and heating modes.</li>
                      <li data-tp="copy">***While using AI Air, the air volume and wind direction are automatically adjusted according to the situation, and AI Air is turned off when the wind direction is changed.</li>
                      <li data-tp="copy">****When AI Air is activated, the radar sensor detects the location of the occupant and automatically activates the direct/indirect wind.</li>
                      <li data-tp="copy">*****The sensing distance of the radar sensor is up to 5m, and there may be differences in the sensing distance depending on the installation and usage environment of the product.</li>
                      <li data-tp="copy">******This function works only with models that have radar sensors.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
        ...
        <section class="thinq-section">
          <div class="inner">
            ...
            <p class="thinq-section-text" data-tp="copy">A platform for your smart LG appliances and devices, ThinQ puts control and convenience at your fingertips, to help <br>you simplify life and enjoy the comforts of home.</p>
            <a href="thinq-link" class="white-btn" data-tp="copy link">Learn More</a>
            <div class="banner">
              <picture> 
                ...
                <img src="./lg-ai/assets/image/ai-gate-image-thinq-banner-mobile.png" alt="A person holds a smartphone with the LG ThinQ app open, managing smart home devices while drinking coffee." loading="lazy" data-tp="alt">  
              </picture>
            </div>
            ...
            <div class="flex-bx">
              <div class="img-bx">
                <figure>
                  <img src="./lg-ai/assets/image/ai-gate-image-thinq-feature01.png" alt="In a modern smart kitchen, a woman uses a voice command to start the washer with LG ThinQ AI, while a man reads on the sofa in the background." loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
                <h3 class="title" data-tp="copy">Simple Control with Voice Assistant</h3>
                <p class="text" data-tp="copy">Tell your appliance exactly what you need by just saying it out, and the AI speaker will listen and check the cycle to let you know.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
            <!-- S : thinq-flex-bx -->
            <div class="flex-bx reverse">
              <div class="img-bx">
                <figure>
                  <img src="./lg-ai/assets/image/ai-gate-image-thinq-feature02.png" alt="A smartphone displays the LG ThinQ app controlling the LG InstaView Slide-In Range oven, enabling efficient product maintenance in the kitchen." loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
                <h3 class="title" data-tp="copy">Efficient Product Maintenance</h3>
                <p class="text" data-tp="copy">Through the LG ThinQ app, check on your appliance, download new cycles, monitor cycle usage, and much more.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
          </div>
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner01-mobile.png" alt="LG Electronics executive holding certificate of accreditation for cybersecurity, with digital security graphic in background" loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG Strengthens Cybersecurity Leadership With KOLAS IoT Cybersecurity Testing Accreditation</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-strengthens-cybersecurity-leadership-with-kolas-iot-cybersecurity-testing-accreditation/" class="white-btn" data-tp="copy link">Learn More</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner02-mobile.png" alt="Visitors viewing LG curved LED display showcasing 'Life's Good 24/7' slogan at tech exhibition" loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG Presents Its Latest Innovations Powered by "Affectionate Intelligence" at CES 2025</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-presents-its-latest-innovations-powered-by-affectionate-intelligence-at-ces-2025/" class="white-btn" data-tp="copy link">Learn More</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner03-mobile.png" alt="Speaker presenting AI-powered B2B solutions on stage at LG event" loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG Unveils a Day in a Life With "Affectionate Intelligence" at LG World Premiere</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-unveils-a-day-in-a-life-with-affectionate-intelligence-at-lg-world-premiere/" class="white-btn" data-tp="copy link">Learn More</a>
                              </div>
                          </div>
                      </div>
                  </div>
