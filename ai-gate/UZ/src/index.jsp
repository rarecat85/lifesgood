...
<head>
    ...
    <title>LG Affectionate Intelligence | LG UZ</title>
    <meta name="Keywords" content="LG AI, G'amx'or intellekt, Inson markazli AI, Smart Hayot Platformasi, Texnologik yechimlar.">
    <meta name="Description" content="LG AI sizning quvonchli, oson va g‘amxo‘r hayotingiz uchun “donolik bilan sezish, chuqur tushunish, iliq g‘amxo‘rlik” tamoyillari bilan xizmat qiladi. LG Affectionate Intelligence bilan hayotingiz sifatini oshiring — insoniy mehr bilan parvarish qiladi.">
    <meta property="og:title" content="LG Affectionate Intelligence | LG UZ"/>
    <meta property="og:url" content="https://www.lg.com/uz/lg-ai">
    <meta property="og:description" content="LG AI sizning quvonchli, oson va g‘amxo‘r hayotingiz uchun “donolik bilan sezish, chuqur tushunish, iliq g‘amxo‘rlik” tamoyillari bilan xizmat qiladi. LG Affectionate Intelligence bilan hayotingiz sifatini oshiring — insoniy mehr bilan parvarish qiladi."/>
...
<div class="sr-only" itemscope itemtype="http://schema.org/WebPage">
    ...
    <meta itemprop="description" content="LG AI sizning quvonchli, oson va g‘amxo‘r hayotingiz uchun “donolik bilan sezish, chuqur tushunish, iliq g‘amxo‘rlik” tamoyillari bilan xizmat qiladi. LG Affectionate Intelligence bilan hayotingiz sifatini oshiring — insoniy mehr bilan parvarish qiladi."/>
    <meta itemprop="Keywords" content="LG AI, G'amx'or intellekt, Inson markazli AI, Smart Hayot Platformasi, Texnologik yechimlar."/>
</div>
      ...
      <div class="gate-container">
        ...
        <section class="kv-section">
          <div class="inner">
            ...
            <h1 id="kv-video-description" class="a11y-text" data-tp="copy">Ayol yonidan o‘tadi — chiroq harakatga javoban avtomatik yoqiladi. Ekranda yozuv paydo bo‘ladi: «Donolik bilan sezish». Erkak va ayol quchoqlashadi — XBOOM karnay yoqiladi, «Chuqur tushunish» yozuvi bilan. Erkak mashinada xafa o‘tiradi. LG AI logotipi va «Iliq g‘amxo‘rlik» yozuvi paydo bo‘ladi. Televizorda futbol o‘yini. LG AI ovozli javob beradi. Pastki qismda: «Quvonchli hayotingiz uchun».
XBOOM, televizor va it bilan birga divanda o‘tirgan oila — bir kadrda uyg‘un tarzda. Ona va o‘g‘il birga kir yuvish mashinasini yoqadi. Yozuv chiqadi: «Oson hayotingiz uchun». Ona va o‘g‘il sahnalari, AI Wash tugmasining yaqin kadri va LG gram noutbukdagi erkak — bitta kadra birlashtirilgan. Yozuv: «Oson hayotingiz uchun». Mashinada old o‘rindiqlarda erkak va ayol. Ular orasida LG AI logotipi va yozuv: «G‘amxo‘r hayot uchun». Kishi it bilan ofisga kiradi. Havo tozalagich avtomatik yoqiladi. Final kadr: oq fon, LG AI logotipi va yozuv: «SIZ uchun mehrli intellekt».</h1>
            ...
            <div class="tab-container" role="tablist">
              ...
              <div class="panel-container">
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products01.png" alt="LG OLED evo AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products02.png" alt="LG OLED AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products03.png" alt="LG QNED AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products04.png" alt="LG NanoCell AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products05.png" alt="LG xboom AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                    </ul>
                    <!-- E : product-list -->
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden="">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI ehtiyojingizni sezadi va hayotingiz o‘z ohangida oson kechishi uchun yechimlar beradi.</h2>
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" data-desktop-video-src="./lg-ai/assets/video/ai-gate-video-benefit02-banner-video-desktop.mp4" data-mobile-video-src="./lg-ai/assets/video/ai-gate-video-benefit02-banner-video-mobile.mp4" data-desktop-poster-src="./lg-ai/assets/image/ai-gate-image-benefit02-banner-desktop.png" data-mobile-poster-src="./lg-ai/assets/image/ai-gate-image-benefit02-banner-mobile.png" aria-labelledby="benefit02-banner-video-description">
                      <span id="benefit02-banner-video-description" class="a11y-text" data-tp="copy">Ona va o‘g‘il LG AI kir yuvish mashinasini birga yoqadi, AI Wash tugmasini aylantiradi. Kadrda LG gram bilan erkak ham bor.</span>
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products01.png" alt="LG WashTower AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products02.png" alt="LG Washing Machine AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products03.png" alt="LG Dryer AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/uz/refrigerators/lg-gr-x24fmkbl" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products04.png" alt="LG InstaView AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Batafsil</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products05.png" alt="LG gramPro AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                    </ul>
                    <!-- E : product-list -->
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden="">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI siz, uyingiz va sayyoraga g‘amxo‘rlik qilib, hayotingizni istagandek qiladi.</h2>
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" data-desktop-video-src="./lg-ai/assets/video/ai-gate-video-benefit03-banner-video-desktop.mp4" data-mobile-video-src="./lg-ai/assets/video/ai-gate-video-benefit03-banner-video-mobile.mp4" data-desktop-poster-src="./lg-ai/assets/image/ai-gate-image-benefit03-banner-desktop.png" data-mobile-poster-src="./lg-ai/assets/image/ai-gate-image-benefit03-banner-mobile.png" aria-labelledby="benefit03-banner-video-description">
                      <span id="benefit03-banner-video-description" class="a11y-text" data-tp="copy">Erkak it yetakchisini ushlab ofisga kiradi. Mashinada o‘tirgan boshqa erkak xafa. LG AI unga oilaviy suratni ko‘rsatadi. Avtomobil ekranida LG AI xaritani chiqaradi va xotirani jonlantiradi.</span>
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/mobility/mobility-labworks-series/adas-solutions/in-cabin-vision" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit03-products02.png" alt="LG DUALCOOL AI oldi ko‘rinishi" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Batafsil</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/mobility/mobility-labworks-series/adas-solutions/in-cabin-vision" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit03-products03.png" alt="Foydalanuvchi ko‘p rejimli AI HMI asosidagi sensorli interfeysda AI yordamchi ko‘magida qahva menyusini tanlamoqda." loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Batafsil</span>
                        </a>
                      </li>
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG AI TV ko‘rish odatlaringizni o‘rganadi va hayot tarzingizni tushunadi, har bir jihatni optimallashtirib, faqat siz uchun ideal shaxsiy ko‘ngilochar tajriba yaratadi.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-banner-mobile.png" alt="LG Magic Remote ustida AI Voice ID, AI Search, AI Chatbot, AI Concierge, AI Picture Wizard va AI Sound Wizard funksiyalari ko‘rsatiladi." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                      ...
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature01.png" alt="LG OLED TV ekranida webOS 25 bosh sahifasi ilovalar va ko‘ngilochar kontent bilan to‘la. Yonida LG AI Magic Remote turibdi, AI tugmasi ovoz orqali faollashtirilgandek yoritilgan. Yonida so‘z buluti: «yoqadigan filmni tavsiya qil»." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Voice ID</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature02.png" alt="LG OLED TV ekranida AI qidiruv qanday ishlashi ko‘rsatilgan. Foydalanuvchi sport o‘yinlari haqida so‘ragan chat oynasi ochiq. AI qidiruv javobni chatda ham, kontent rasmlari bilan ham beradi. Shuningdek, Microsoft Copilot so‘rashi uchun taklif chiqadi." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Search</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature03.png" alt="LG AI Magic Remote ishlatilmoqda. AI tugmasini qisqacha bosish OLED TV ekranida yordamchini yoqadi, so‘ngra kalit so‘zlar ko‘rsatiladi." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Concierge</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature04.png" alt="LG OLED TV ekranida ilmiy-fantastik kontent ijro etilmoqda. Chap tomonda AI Chatbot interfeysi ko‘rsatilgan. Foydalanuvchi ekran juda qorong‘i deb yozadi, chatbot esa muammoni hal qilish yo‘llarini taklif qiladi." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Chatbot</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature05.png" alt="Ayol mikrofon orqali kuylamoqda, quloqchin taqgan, ovoz LG α11 AI protsessori bilan kuchaytirilgan." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Tasvir/Tovush Ustasi</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-tv-feature06.png" alt="Televizor oldida LG AI Magic Remote bilan bog‘liq ikki sahna: birinchi — fantastik film, ikkinchisi — shaxsiy kontentli asosiy ekran." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Magic pult </p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*LG AI features use deep learning-based trained algorithms for real-time image upscaling and sound upmixing.</li>
                      <li data-tp="copy">**All LG webOS 24 TVs feature AI Customization, excluding those without light sensors.</li>
                    </ul>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG XBOOM AI janr va makonga mos ravishda ovozni tahlil qilib, sozlaydi. AI yoritish muhitni boyitadi va musiqaga moslashadi, siz esa o‘ziga xos tovush va kayfiyatdan bahramand bo‘lasiz.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-banner-mobile.png" alt="Ayol va erkak mehmonxonada quchoqlashmoqda, ularning yonida XBOOM karnay yoqilgan." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">LG XBOOM AI bilan <br>
                          yangi ovoz dunyosini kashf eting </h3>
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-feature01.png" alt="Bass Boost, Voice Enhance va Standard rejimlariga ega LG XBOOM AI karnayi." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Sound</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-feature02.png" alt="LG XBOOM karnayi AI yoritish bilan, u ovoz, muhit va bayram rejimiga moslashadi" data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Lighting</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-feature03.png" alt="LG XBOOM karnayi qizil tusli, panjarali devorlar va zamonaviy mebellarga ega xonadagi stol ustida joylashgan." data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Bu mahsulot hali mavjud emas.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->  
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG WashTower AI nima yuvilayotganini aniqlab, nozik matolar uchun optimal parvarishni tanlaydi va har gal yukni mukammal yuvishda yordam beradi.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-appliances-banner-mobile.png" alt="LG kir va quritish mashinalari yog‘ochli va o‘rindiqli kir yuvish xonasida ustma-ust o‘rnatilgan." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">LG AI Core Tech bilan <br>
                          yangi hayotni kashf eting</h3>
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-appliances-feature01.png" alt="AI Wash rejimi LG mashinasida aqlli aylantirgich yordamida sozlanmoqda." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Wash</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-appliances-feature02.png" alt="LG quritgichda AI Dry rejimi raqamli disk orqali tanlanmoqda." data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Bu mahsulot tanlangan mamlakatlarda bosqichma-bosqich taqdim etiladi.</li>
                      <li data-tp="copy">**AI aniqlash 6 kg dan kam yukda faollashadi.</li>
                      <li data-tp="copy">***AI Wash faqat bir xil matolar va mos yuvish vositalari bilan ishlatilishi kerak [har doim mato aniqlanmaydi].</li>
                      <li data-tp="copy">****AI Dry faqat 5 kg gacha bo‘lgan yuk va bir xil namlikni yutuvchi matolar uchun mavjud.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG DUALCOOL AI qulay havo va energiya tejamkorligini ta’minlaydi. LG AI Air bilan siz uchun moslashtirilgan ideal sovitishni boshdan kechiring.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-banner-mobile.png" alt="LG DUAL Inverter konditsioneri zamonaviy mehmonxonani sovutadi, ayol divanda o‘tirgan, ThinQ AI texnologiyasi yordamida ishlaydi." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title text-black" data-tp="copy">LG AI Air bilan <br>
                           qulaylikni his eting</h3>
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature01.png" alt="Ayol zamonaviy mehmonxonada dam olmoqda, LG AI konditsioneri avtomatik tarzda harorat, havo oqimi va namlikni sozlamoqda." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Air</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature02.png" alt="Smartfonda LG konditsioneri yonida energiya sarfi grafikasi ko‘rsatilgan, AI kW Manager yordamida energiya samaradorligi nazorat qilinadi." data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*AI Air masofaviy pult yoki ThinQ ilovasi orqali boshqariladi.</li>
                      <li data-tp="copy">**AI Air sovitish va isitish rejimlarida mavjud.</li>
                      <li data-tp="copy">***AI Air yoqilganida havo miqdori va yo‘nalishi holatga qarab avtomatik sozlanadi. Shamol yo‘nalishi qo‘lda o‘zgartirilganda, AI Air o‘chadi.</li>
                      <li data-tp="copy">****AI Air faollashtirilganda, radar datchigi foydalanuvchi joylashuvini aniqlaydi va to‘g‘ridan-to‘g‘ri yoki bilvosita shamolni avtomatik ishga tushiradi.</li>
                      <li data-tp="copy">*****Radar datchigining aniqlash masofasi 5 m gacha. Masofa qurilmaning o‘rnatilishi va foydalanish muhitiga qarab farq qilishi mumkin.</li>
                      <li data-tp="copy">******Bu funksiya faqat radar datchigi mavjud modellarda ishlaydi.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG gram AI ish faoliyatingizni onlayn va oflayn yaxshilaydi. Gram chat yordamida oflayn fayllarni toping va qayta ishlang, onlayn samaradorlikni GPT-4o bilan gram chat bulutda oshiring.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-computing-banner-mobile.png" alt="Ayol LG gram noutbuki yordamida videokonferensiyalar va ko‘p vazifali ishlar uchun ikki ekranli tizimda ishlamoqda." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title text-black" data-tp="copy">LG gram AI bilan <br>
                          cheksiz yangi imkoniyatlarga ega bo‘ling</h3>
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-computing-feature01.png" alt="LG gram noutbuki On-Device AI va ekranda aqlli yordamchi interfeysi bilan." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">gram Chat On-Device</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./lg-ai/assets/image/ai-gate-image-product-category-computing-feature02.png" alt="LG gram noutbuki Cloud AI yordamida onlayn qo‘llab-quvvatlash va samaradorlik uchun aqlli interfeysni ko‘rsatadi." data-tp="alt">
                            </div>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Mahsulotni dastlabki ishlatish bosqichlarida ba'zi funksiyalar silliq ishlamasligi mumkin. Bu AI qurilmasining tabiati bilan bog‘liq, foydalanuvchiga moslashish uchun vaqt kerak.</li>
                      <li data-tp="copy">*gram Chat On-Device PC kontentini so‘zlar va ma’lumotlar bilan birlashtirib topish uchun indekslashni talab qiladi, natijalarni olish uchun vaqt kerak.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
          ...
          <div class="inner">
            ...
            <div class="banner">
              <picture> 
                ...
                <img src="./lg-ai/assets/image/ai-gate-image-thinq-banner-mobile.png" alt="Shaxs LG ThinQ ilovasi ochilgan holda smartfonni ushlab, uy jihozlarini boshqarayotib qahva ichmoqda." loading="lazy" data-tp="alt">  
              </picture>
            </div>
            ...
            <div class="flex-bx">
              <div class="img-bx">
                <figure>
                  <img src="./lg-ai/assets/image/ai-gate-image-thinq-feature01.png" alt="Zamonaviy aqlli oshxonada ayol LG ThinQ AI bilan kir yuvish mashinasini ovozli buyruq bilan ishga tushiradi, orqa planda erkak o‘qiydi." loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
            ...
            <div class="flex-bx reverse">
              <div class="img-bx">
                <figure>
                  <img src="./lg-ai/assets/image/ai-gate-image-thinq-feature02.png" alt="Smartfon LG ThinQ ilovasini ko‘rsatadi, LG InstaView Slide-In Range pechini boshqaradi, oshxonada samarali xizmat ko‘rsatishni ta’minlaydi." loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner01-mobile.png" alt="LG Electronics rahbari kiberxavfsizlik bo‘yicha akkreditatsiya sertifikati bilan, orqa fonida raqamli xavfsizlik grafikasi." loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG KOLAS akkreditatsiyasi bilan IoT kiberxavfsizlikda yetakchilikni mustahkamlaydi.</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-strengthens-cybersecurity-leadership-with-kolas-iot-cybersecurity-testing-accreditation/" class="white-btn" data-tp="copy link">Batafsil</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner02-mobile.png" alt="Tadbirda &quot;Life's Good 24/7&quot; shiori bilan LG LED ekranini ko‘rgan mehmonlar." loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG 2025 yil CESda “Mehrli intellekt” bilan yangi innovatsiyalarini taqdim etadi.</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-presents-its-latest-innovations-powered-by-affectionate-intelligence-at-ces-2025/" class="white-btn" data-tp="copy link">Batafsil</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./lg-ai/assets/image/ai-gate-image-more-about-lg-ai-banner03-mobile.png" alt="Spiker LG tadbirida AI yordamida B2B yechimlarini taqdim etmoqda" loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                                  <p data-tp="copy">LG “Mehrli intellekt” bilan hayot kunini LG World Premiere’da taqdim etadi.</p>
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-unveils-a-day-in-a-life-with-affectionate-intelligence-at-lg-world-premiere/" class="white-btn" data-tp="copy link">Batafsil</a>
                              </div>
                          </div>
                      </div>
                  </div>
