...
<head>
    ...
    <title>LG Sirsnīgais intelekts | LG LV</title>
    <meta name="Keywords" content="LG AI, sirsnīgs intelekts, uz cilvēku orientēts AI, viedās dzīves platforma, tehnoloģiski progresīvi risinājumi">
    <meta name="Description" content="LG AI tiecas pēc jūsu apburošas, bez piepūles un labi aprūpētas dzīves, izmantojot “gudru uztveri, dziļu izpratni un sirsnīgu rūpju”. Izbaudiet augstāku dzīves kvalitāti ar LG Affectionate Intelligence, kur AI sniedzas tālāk par mākslīgo intelektu, lai nodrošinātu siltu, uz cilvēku orientētu aprūpi.">
    <meta property="og:title" content="LG Sirsnīgais intelekts | LG LV"/>
    <meta property="og:url" content="https://www.lg.com/lv/lg-ai">
    <meta property="og:description" content="LG AI tiecas pēc jūsu apburošas, bez piepūles un labi aprūpētas dzīves, izmantojot “gudru uztveri, dziļu izpratni un sirsnīgu rūpju”. Izbaudiet augstāku dzīves kvalitāti ar LG Affectionate Intelligence, kur AI sniedzas tālāk par mākslīgo intelektu, lai nodrošinātu siltu, uz cilvēku orientētu aprūpi."/>
...
<div class="sr-only" itemscope itemtype="http://schema.org/WebPage">
    ...
    <meta itemprop="description" content="LG AI tiecas pēc jūsu apburošas, bez piepūles un labi aprūpētas dzīves, izmantojot “gudru uztveri, dziļu izpratni un sirsnīgu rūpju”. Izbaudiet augstāku dzīves kvalitāti ar LG Affectionate Intelligence, kur AI sniedzas tālāk par mākslīgo intelektu, lai nodrošinātu siltu, uz cilvēku orientētu aprūpi."/>
    <meta itemprop="Keywords" content="LG AI, sirsnīgs intelekts, uz cilvēku orientēts AI, viedās dzīves platforma, tehnoloģiski progresīvi risinājumi"/>
</div>
...
Televizorā tiek rādīta futbola spēle. LG AI atbild ar balss mijiedarbību. Zemāk redzama frāze "For your delightful life" (jūsu apburošajai dzīvei).
Vienā kadrā redzami XBOOM, televizors un ģimene, kas sēž uz dīvāna ar savu suni.
Māte un dēls kopā lieto veļas mašīnu. Parādās frāze "For your effortless life" (jūsu bez piepūles dzīvei).
Ainas, kurās redzama māte un dēls, AI Wash skalas tuvplāns un vīrietis, kas lieto LG Gram klēpjdatoru, ir saliktas vienā kadrā ar frāzi "For your effortless life" (jūsu bez piepūles dzīvei).
Vīrietis un sieviete sēž automašīnas priekšējos sēdekļos. Starp viņiem parādās LG AI logotips kopā ar frāzi "For your well cared life" (jūsu labi aprūpētai dzīvei).
Cilvēks ienāk birojā ar savu suni. Gaisa attīrītājs reaģējot ieslēdzas.
Pēdējais attēls: balts fons ar LG mākslīgā intelekta logotipu un frāzi "Sirsnīgs intelekts JUMS".</h1>
        ...
        <section class="overview-section">
          <div class="inner">
            ...
            <p class="text" data-tp="copy">Uzņēmumā LG mēs sev esam uzdevuši jautājumu: kāpēc mākslīgajam intelektam vajadzētu pastāvēt? <br>
              Pēc ilgām pārdomām esam atraduši atbildi. <br><br>
              Mūsuprāt, mākslīgais intelekts ir kas vairāk nekā tikai mākslīgais intelekts — tas ir sirsnīgs intelekts. <br><br>
              Mākslīgajam intelektam kļūstot par mūsu ikdienas dzīves sastāvdaļu, <br>
              tam vajadzētu palīdzēt radīt labāku dzīvi, kādu mēs visi esam pelnījuši. <br><br>
        ...
        <section class="product-section">
          <div class="inner">
            <div class="tab-container" role="tablist">
              <!-- S : tab-list -->
              <div class="tab-list">
                <button class="tab active" role="tab" aria-selected="true" aria-controls="product-panel-1" id="product-tab-1" data-tp="copy">Apburoša dzīve</button>
                <button class="tab" role="tab" aria-selected="false" aria-controls="product-panel-2" id="product-tab-2" data-tp="copy">Dzīve bez piepūles</button>
                <button class="tab" role="tab" aria-selected="false" aria-controls="product-panel-3" id="product-tab-3" data-tp="copy">Labi aprūpēta dzīve</button>
              </div>
              <!-- E : tab-list -->
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG mākslīgais intelekts izprot jūsu dzīvi un uzlabo pieredzi, lai jūsu dzīve būtu piepildīta ar patīkamiem mirkļiem.</h2>
                    <!-- S : video-bx -->
...
Kamera fokusējas uz blakus esošo LG XBOOM skaļruni.</span>
        ...
        <section class="feature-section">
          <div class="inner">
            <div class="tab-container" role="tablist">
              <!-- S : tab-list -->
              <div class="tab-list">
                <button class="tab active" role="tab" aria-selected="true" aria-controls="feature-panel-1" id="feature-tab-1" data-tp="copy">Televizors</button>
                <button class="tab" role="tab" aria-selected="false" aria-controls="feature-panel-2" id="feature-tab-2" data-tp="copy">Audio</button>
                <button class="tab" role="tab" aria-selected="false" aria-controls="feature-panel-3" id="feature-tab-3" data-tp="copy">Sadzīves tehnika</button>
                ...
                <button class="tab" role="tab" aria-selected="false" aria-controls="feature-panel-5" id="feature-tab-5" data-tp="copy">Datorika</button>
              </div>
              <!-- E : tab-list -->
              <!-- S : panel-container -->
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG AI televizors apgūst jūsu skatīšanās preferences un izprot jūsu dzīvesveidu, lai optimizētu katru jūsu skatīšanās pieredzes aspektu, radot ideālu personalizētu izklaidi tieši jums.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">Iepazīstieties ar nākamās paaudzes<br>
                          LG AI televizoru</h3>
                        <a href="https://www.lg.com/lv/televizori/ai-tv" class="white-btn" data-tp="copy link">Uzzināt vairāk</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                    ...
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*LG mākslīgā intelekta funkcijas izmanto dziļās mācīšanās algoritmus attēla uzlabošanai un skaņas miksēšanai reāllaikā.</li>
                      <li data-tp="copy">**Visiem LG webOS 24 televizoriem ir mākslīgā intelekta pielāgošanas funkcija, izņemot tos, kuriem nav gaismas sensoru.</li>
                    </ul>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG xboom AI analizē un pielāgo skaņu žanram un telpai. Ar AI apgaismojumu, kas uzlabo atmosfēru un harmonizējas ar jūsu mūziku, jūs varat baudīt unikāli atbilstošu skaņu un vibrāciju.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Šis produkts vēl nav pieejams.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->  
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG WashTower mākslīgais intelekts uztver, ko jūs mazgājat, lai nodrošinātu optimizētu mazgāšanu jutīgiem audumiem, nodrošinot, ka jūs bez piepūles perfekti veicat katru veļas mazgāšanu, katru reizi.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Šis produkts tiks pakāpeniski izlaists atsevišķās valstīs.</li>
                      <li data-tp="copy">**AI noteikšana tiek aktivizēta, ja veļas svars ir mazāks par 6 kg.</li>
                      <li data-tp="copy">***AI mazgāšanas režīmu drīkst izmantot tikai ar līdzīga veida audumiem [ne visi audumi tiek atpazīti] un piemērotu mazgāšanas līdzekli.</li>
                      <li data-tp="copy">****AI žāvēšanas režīms ir pieejams tikai veļas svaram, kas mazāks par 5 kg, ar audumiem ar vienādu mitruma absorbcijas līmeni.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG DUALCOOL AI rūpējas par optimālu gaisa kvalitāti, nodrošinot komfortu un vienlaikus optimizējot energoefektivitāti, lai palīdzētu ietaupīt izmaksas. Ar LG AI Air izbaudiet perfekti noregulētu dzesēšanu savam komfortam.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*AI Air var vadīt, izmantojot tālvadības pulti un ThinQ.</li>
                      <li data-tp="copy">**AI Air ir pieejams gan dzesēšanas, gan sildīšanas režīmā.</li>
                      <li data-tp="copy">***Izmantojot AI Air, gaisa apjoms un vēja virziens tiek automātiski pielāgoti atbilstoši situācijai, un AI Air tiek izslēgts, mainot vēja virzienu.</li>
                      <li data-tp="copy">****Kad AI Air ir aktivizēts, radara sensors nosaka iemītnieka atrašanās vietu un automātiski aktivizē tiešo/netiešo vēju.</li>
                      <li data-tp="copy">*****Radara sensora uztveršanas attālums ir līdz 5 m, un uztveršanas attālums var atšķirties atkarībā no produkta uzstādīšanas un lietošanas vides.</li>
                      <li data-tp="copy">******Šī funkcija darbojas tikai ar modeļiem, kuriem ir radara sensori.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
                  <div class="tab-panel-inner">
                    ...
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG Gram mākslīgais intelekts uzlabo jūsu darbu gan tiešsaistē, gan bezsaistē. Droši atrodiet un apkopojiet failus bezsaistē, izmantojot Gram tērzēšanu ierīcē, un palieliniet savu produktivitāti tiešsaistē ar GPT-4o darbinātu Gram tērzēšanas mākoni.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                      ...
                      <div class="text-bx">
                        <h3 class="title text-black" data-tp="copy">Atklājiet savas jaunās spējas bez ierobežojumiem <br>
                         ar LG gramatisko mākslīgo intelektu</h3>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">*Produkta lietošanas sākumposmā dažas funkcijas var nedarboties nevainojami. Tas ir saistīts ar ierīcē iebūvētā mākslīgā intelekta specifiku, kam nepieciešams laiks iepriekšējai apmācībai, lai pielāgotos lietotājam.</li>
                      <li data-tp="copy">*Lai atrastu saturu datorā, grama tērzēšanai ierīcē ir nepieciešami indeksēšanas uzdevumi, apvienojot vārdus ar datiem, un vēlamo rezultātu iegūšanai var būt nepieciešams zināms laiks.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
        ...
        <section class="thinq-section">
          <div class="inner">
            <h2 class="thinq-section-title" data-tp="copy">ThinQ® palīdz dzīvei piepildīties</h2>
            <p class="thinq-section-text" data-tp="copy">ThinQ ir platforma jūsu viedajām LG ierīcēm un ierīcēm, kas nodrošina kontroli un ērtības jūsu pirkstu galos, lai palīdzētu vienkāršot dzīvi un baudīt mājas komfortu.</p>
            ...
            <div class="flex-bx">
              ...
              <div class="text-bx">
                <h3 class="title" data-tp="copy">Vienkārša vadība ar balss palīgu</h3>
                <p class="text" data-tp="copy">Pasakiet savai LG ierīcei tieši to, kas jums nepieciešams, vienkārši to pasakot, un mākslīgā intelekta skaļrunis uzklausīs un pārbaudīs ciklu, lai jūs par to informētu.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
            <!-- S : thinq-flex-bx -->
            <div class="flex-bx reverse">
              ...
              <div class="text-bx">
                <h3 class="title" data-tp="copy">Efektīva produktu apkope</h3>
                <p class="text" data-tp="copy">Izmantojot LG ThinQ lietotni, pārbaudiet savu LG ierīci, lejupielādējiet jaunus ciklus, uzraugiet ciklu lietojumu un veiciet daudz ko citu.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
          </div>
        ...
        <section class="stories-section">
          <div class="inner">
              <h2 class="title" data-tp="copy">Vairāk par LG sirsnīgo intelektu</h2>
              <div class="slide-bx">
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-strengthens-cybersecurity-leadership-with-kolas-iot-cybersecurity-testing-accreditation/" class="white-btn" data-tp="copy link">Uzzināt vairāk</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-presents-its-latest-innovations-powered-by-affectionate-intelligence-at-ces-2025/" class="white-btn" data-tp="copy link">Uzzināt vairāk</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-unveils-a-day-in-a-life-with-affectionate-intelligence-at-lg-world-premiere/" class="white-btn" data-tp="copy link">Uzzināt vairāk</a>
                              </div>
                          </div>
                      </div>
                  </div>
