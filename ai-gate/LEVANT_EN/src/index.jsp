          ...
          <div class="panel-container">
              ...
              <div class="tab-panel-inner">
                ...
                <ul class="product-list">
                  <li class="product-item">
                    <a href="https://www.lg.com/levant_en/oled-tvs"> 
                      <div class="img-bx">
                  ...
                  <li class="product-item">
                    <a href="https://www.lg.com/levant_en/qned-tvs"> 
                      <div class="img-bx">
                  ...
                  <li class="product-item">
                    <a href="https://www.lg.com/levant_en/nanocell-tvs"> 
                      <div class="img-bx">
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden>
              <div class="tab-panel-inner">
                ...
                <ul class="product-list"> 
                  <li class="product-item">
                    <a href="https://www.lg.com/levant_en/refrigerators/lg-gcx-287tvsi"> 
                      <div class="img-bx">
              ...
              <div class="tab-panel-inner">
                ...
                <div class="tab-panel-banner">
                  ...
                  <div class="text-bx">
                    ...
                    <a href="https://www.lg.com/levant_en/tvs-soundbars/ai-tv" class="white-btn" data-tp="copy link">Learn More</a>
                  </div>
                </div>
                <!-- E : tab-panel-banner -->
                <!-- S : tab-panel-slide -->
              ...
              <div class="tab-panel-inner">
                ...
                <div class="tab-panel-banner">
                  ...
                  <div class="text-bx">
                    ...
                    <a href="https://www.lg.com/levant_en/lg-ai-core-tech/washing-machine-dryer" class="white-btn">Learn More</a>
                  </div>
                </div>
                <!-- E : tab-panel-banner -->
                <!-- S : tab-panel-slide -->
