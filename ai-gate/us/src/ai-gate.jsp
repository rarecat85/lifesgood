              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" 
                      data-desktop-video-src="./assets/video/ai-gate-video-benefit01-banner-video-desktop.mp4" data-mobile-video-src="./assets/video/ai-gate-video-benefit01-banner-video-mobile.mp4"
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                          ...
                          <span class="link-btn">Buy Now</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden>
                  <div class="tab-panel-inner">
                    ...
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" 
                      data-desktop-video-src="./assets/video/ai-gate-video-benefit02-banner-video-desktop.mp4" data-mobile-video-src="./assets/video/ai-gate-video-benefit02-banner-video-mobile.mp4"
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit02-products01.png" alt="LG Washing Machine AI product front view" loading="lazy">
                          </div>
                          <span class="link-btn">Buy Now</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit02-products02.png" alt="LG InstaView AI product front view" loading="lazy">
                          </div>
                          <span class="link-btn">Buy Now</span>
                        </a>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit02-products03.png" alt="LG gramPro AI product front view" loading="lazy">
                          </div>
                          <span class="link-btn">Buy Now</span>
                        </a>
                      </li>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden>
                  <div class="tab-panel-inner">
                    ...
                    <!-- S : video-bx -->
                    <div class="video-bx responsive-video" 
                      data-desktop-video-src="./assets/video/ai-gate-video-benefit03-banner-video-desktop.mp4" data-mobile-video-src="./assets/video/ai-gate-video-benefit03-banner-video-mobile.mp4"
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/global/lg-ai/common/">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI product front view" loading="lazy">
                          </div>
                          <span class="link-btn">Buy Now</span>
                        </a>
                      </li>
              ...
              <div class="panel-container">
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title">
                          Meet the next <br>
                          generation of LG AI TV
                        </h3>
                        <a href="#;" class="white-btn layer-open layer-tv">Learn More</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="AI Voice ID with My Profile syncs to you" data-desc="LG AI Voice ID knows each user's unique voice signature and offers personalized recommendations the moment you turn it on and speak." data-alt="On an LG OLED TV screen is the webOS 25 home page filled with apps and entertainment content. By the TV is the LG AI Magic Remote, the AI button is highlighted as if activated by the user's voice. A speech bubble is beside it, 'suggest a movie I'll like'">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature01.png" alt="On an LG OLED TV screen is the webOS 25 home page filled with apps and entertainment content. By the TV is the LG AI Magic Remote, the AI button is highlighted as if activated by the user's voice. A speech bubble is beside it, 'suggest a movie I'll like'">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="Find answers instantly with AI Search" data-desc="Voice-activated intelligence powered by built-in AI understands your inquiries. Ask questions and get tailored recommendations that meet your needs. You can also get additional results and solutions with Microsoft Copilot." data-alt="LG OLED TV screen showing how AI Search works. A small chat window is open showing how the user asked for what sports games are available. AI search responded via chat and by showing thumbnails of different available content. There is also a prompt to ask Microsoft Copilot.">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature02.png" alt="LG OLED TV screen showing how AI Search works. A small chat window is open showing how the user asked for what sports games are available. AI search responded via chat and by showing thumbnails of different available content. There is also a prompt to ask Microsoft Copilot.">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="Enjoy one-click personalized recommendations with AI Concierge " data-desc="One short press on the AI button on your remote opens up your AI Concierge which provides customized keywords and recommendations based on your search and watching history." data-alt="The LG AI Magic Remote in use. Shortly pressing the AI button activates the AI Assistant on the OLED TV screen, which then suggests keywords.">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature03.png" alt="The LG AI Magic Remote in use. Shortly pressing the AI button activates the AI Assistant on the OLED TV screen, which then suggests keywords.">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="Solve requests in real-time with AI Chatbot" data-desc="Have your own AI Chatbot actively resolve and help you with your requests. Simply speak to your TV as it can classify your intentions and respond accordingly." data-alt="Sci-fi content is playing on an LG OLED TV screen. On the left side of the screen is the AI Chatbot interface. The user messages the chatbot that the screen is too dark and the chatbot offers solutions to the request.">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature04.png" alt="Sci-fi content is playing on an LG OLED TV screen. On the left side of the screen is the AI Chatbot interface. The user messages the chatbot that the screen is too dark and the chatbot offers solutions to the request.">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="Complete your AI experience with AI Magic Remote featuring a dedicated AI button." data-desc="Control your TV easily with AI magic remote - no extra device needed! Simple but powerful click, drag and drop functions make using webOS intuitive and easy to operate." data-alt="Two connected scenes with LG AI Magic Remote in front of a TV—first showing a sci-fi scene, second showing a home screen with personalized content">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature06.png" alt="Two connected scenes with LG AI Magic Remote in front of a TV—first showing a sci-fi scene, second showing a home screen with personalized content">
                            </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title">
                          Enjoy a new sound experience with <br>
                          LG xboom AI
                        </h3>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title">
                          Discover a new way of life with LG AI <br>
                          Core Tech
                        </h3>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title">
                          Experience optimized comfort with <br>
                          LG AI Air
                        </h3>
                        ...
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="AI kW Manager" data-desc="AI kW Manager intelligently monitors and controls electricity consumption to optimize energy efficiency and reduce utility costs." data-alt="Smartphone interface showing energy consumption graph in front of LG air conditioner, highlighting AI kW Manager for efficient power monitoring">
                              <img src="./assets/image/ai-gate-image-product-category-air-conditioning-feature02.png" alt="Smartphone interface showing energy consumption graph in front of LG air conditioner, highlighting AI kW Manager for efficient power monitoring">
                            </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
                  <div class="tab-panel-inner">
                    <!-- S : tab-panel-title -->
                    <h2 class="tab-panel-title">
                      <img src="./assets/image/ai-product-category-computing-eyebrow-logo-desktop.svg" alt="LG AI Computing" class="eyebrow-logo" loading="lazy">  
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-computing-banner-mobile.png" alt="A woman uses an LG gram laptop with a dual screen setup for video conferencing and multitasking in her home office." loading="lazy">
                      </picture>
                      <div class="text-bx">
                        <h3 class="title text-black">
                          Unleash your new abilities without <br>
                          limits with LG gram AI
                        </h3>
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="gram Chat On-Device" data-desc="gram Chat On-Device offers secure, offline AI assistance for file organization, search, and content summarization directly on your laptop." data-alt="LG gram laptop featuring On-Device AI with smart assistant interface on screen">
                              <img src="./assets/image/ai-gate-image-product-category-computing-feature01.png" alt="LG gram laptop featuring On-Device AI with smart assistant interface on screen">
                            </div>
                          ...
                          <div class="swiper-slide">
                            <div class="img-bx" data-title="gram Chat Cloud" data-desc="gram Chat Cloud leverages powerful cloud-based AI to enhance productivity with advanced content creation, research, and analysis capabilities." data-alt="LG gram laptop with Cloud AI displaying smart assistant interface for online support and productivity">
                              <img src="./assets/image/ai-gate-image-product-category-computing-feature02.png" alt="LG gram laptop with Cloud AI displaying smart assistant interface for online support and productivity">
                            </div>
                    ...
                    <ul class="tab-panel-disclaimer">
                      ...
                      <li>*Time Travel: Search functionality becomes available after 5 minutes. The system captures the PC screen approximately once every 2 seconds, with a storage capacity of about 13GB. Captured images will be automatically deleted after a certain period. Users can modify settings regarding the use of this feature, screen storage duration, and capacity by clicking the gear icon at the top of gram Chat.</li>
                      <li>*AI Search: The responses may vary depending on the data available at the time of the search, and accuracy cannot be guaranteed, so user verification is necessary. Only documents containing keywords (*.doc(x), *.ppt(x), *.hwp(x), *.pdf) and image files (*.jpg, *.gif, *.png) can be searched.</li>
                      <li>*AI Summary: This feature can summarize about 4,000 tokens, which is roughly 10 pages of text. It can handle around 4,000 characters in Korean and about 9,000 characters in English. For translations, it can manage about 2,500 characters in Korean and 5,000 characters in English, but it may not cover every possible language situation.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
        ...
        <section class="thinq-section">
          <div class="inner">
            ...
            <div class="flex-bx">
              <div class="img-bx">
                <figure>
                  <img src="./assets/image/ai-gate-image-thinq-on-feature03.png" alt="In a modern smart kitchen, a woman uses a voice command to start the washer with LG ThinQ AI, while a man reads on the sofa in the background." loading="lazy">
                </figure>
              </div>
              <div class="text-bx">
            ...
            <div class="flex-bx reverse">
              <div class="img-bx">
                <figure>
                  <img src="./assets/image/ai-gate-image-thinq-on-feature04.png" alt="A smartphone displays the LG ThinQ app controlling the LG InstaView Slide-In Range oven, enabling efficient product maintenance in the kitchen." loading="lazy">
                </figure>
              </div>
              <div class="text-bx">
