...
<head>
    ...
    <title>LG Affectionate Intelligence | LG UAE</title>
    ...
    <meta property="og:title" content="LG Affectionate Intelligence | LG UAE"/>
    <meta property="og:url" content="https://www.lg.com/ae_en/lg-ai">
    ...
    <!-- your -->
    <link href="/ae/lg-ai/common/css/ai-gate-reset.css" rel="stylesheet" type="text/css" />
    <link href="/ae/lg-ai/common/css/ai-gate-swiper-bundle.min.css" rel="stylesheet" type="text/css" />
    <link href="/ae/lg-ai/assets/css/ai-gate-css.css" rel="stylesheet" type="text/css" />

    <script src="/ae/lg-ai/common/js/ai-gate-swiper-bundle.min.js"></script>
    <script src="/ae/lg-ai/assets/js/ai-gate-js-common.js" defer></script>
  ...
  <div class="gate-container">
    ...
    <section class="kv-section">
      <div class="inner">
        ...
        data-desktop-video-src="/ae/lg-ai/assets/video/ai-gate-video-kv-video-desktop.mp4" 
        data-mobile-video-src="/ae/lg-ai/assets/video/ai-gate-video-kv-video-mobile.mp4"
        data-desktop-poster-src="/ae/lg-ai/assets/image/ai-gate-image-kv-desktop.png" 
        data-mobile-poster-src="/ae/lg-ai/assets/image/ai-gate-image-kv-mobile.png" 
    ...
    <section class="overview-section">
      <div class="inner">
        <picture>
          <source media="(min-width: 768px)" srcset="/ae/lg-ai/assets/image/ai-gate-image-overview-ai-logo-desktop.svg">
          <source media="(max-width: 767px)" srcset="/ae/lg-ai/assets/image/ai-gate-image-overview-ai-logo-mobile.svg">
          <img src="/ae/lg-ai/assets/image/ai-gate-image-overview-ai-logo-mobile.svg" alt="LG AI" class="ai-logo">
        </picture>
        <h2 class="title">
        ...
        <img src="/ae/lg-ai/assets/image/ai-gate-image-overview-scroll-down-icon-desktop.svg" alt="Scroll down icon" class="scroll-down-icon">
      </div>
    </section>
    <!-- E : overview-section -->
    <!-- S : product-section -->
          ...
          <div class="panel-container">
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
              <div class="tab-panel-inner">
                ...
                <!-- S : video-bx -->
                <div class="video-bx responsive-video" 
                  data-desktop-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit01-banner-desktop.mp4" data-mobile-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit01-banner-mobile.mp4"
                  data-desktop-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-banner-desktop.png" 
                  data-mobile-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-banner-mobile.png" 
                ...
                <ul class="product-list">
                  <li class="product-item">
                    <a href="https://www.lg.com/ae/oled-evo">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-products01.png" alt="LG OLED evo AI product front view" loading="lazy">
                      </div>
                      <span class="link-btn">Learn More</span>
                    </a>
                  </li>
                  <li class="product-item">
                    <a href="https://www.lg.com/ae/oled-tvs">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-products02.png" alt="LG OLED AI product front view" loading="lazy">
                      </div>
                      <span class="link-btn">Learn More</span>
                    </a>
                  </li>
                  <li class="product-item">
                    <a href="https://www.lg.com/ae/qned-tvs">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-products03.png" alt="LG QNED AI product front view" loading="lazy">
                      </div>
                      <span class="link-btn">Learn More</span>
                    </a>
                  </li>
                  ...
                  <li class="product-item">
                    <a href="https://www.lg.com/ae/sound-bars">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit01-products05.png" alt="LG xboom AI product front view" loading="lazy">
                      </div>
                      <span class="link-btn">Learn More</span>
                    </a>
                  </li>
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden>
              <div class="tab-panel-inner">
                ...
                <!-- S : video-bx -->
                <div class="video-bx responsive-video" 
                  data-desktop-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit02-banner-desktop.mp4" data-mobile-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit02-banner-mobile.mp4"
                  data-desktop-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit02-banner-desktop.png" 
                  data-mobile-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit02-banner-mobile.png" 
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden>
              <div class="tab-panel-inner">
                ...
                <!-- S : video-bx -->
                <div class="video-bx responsive-video" 
                  data-desktop-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit03-banner-desktop.mp4" data-mobile-video-src="/ae/lg-ai/assets/video/ai-gate-video-benefit03-banner-mobile.mp4"
                  data-desktop-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit03-banner-desktop.png" 
                  data-mobile-poster-src="/ae/lg-ai/assets/image/ai-gate-image-benefit03-banner-mobile.png" 
                ...
                <ul class="product-list">
                  <li class="product-item">
                    <a href="https://www.lg.com/ae/non-tropical-split-air-conditioners">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI product front view" loading="lazy">
                      </div>
                      <span class="link-btn">Learn More</span>
                    </a>
                  </li>
                  <li class="product-item">
                    <a href="javascript:void(0)">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit03-products02.png" alt="ADAS vision system product side view" loading="lazy">
                      </div>
                      <!-- <span class="link-btn">Learn More</span> -->
                    </a>
                  </li>
                  <li class="product-item">
                    <a href="javascript:void(0)">
                      <div class="img-bx">
                        <img src="/ae/lg-ai/assets/image/ai-gate-image-benefit03-products03.png" alt="User interacting with touchscreen interface powered by multimodal AI HMI solution, selecting coffee menu with AI assistant prompt" loading="lazy">
                      </div>
                      <!-- <span class="link-btn">Learn More</span> -->
                    </a>
                  </li>
          ...
          <div class="panel-container">
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
              <div class="tab-panel-inner">
                ...
                <h2 class="tab-panel-title">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-eyebrow-logo-desktop.svg" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-eyebrow-logo-mobile.svg" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-eyebrow-logo-mobile.svg" alt="LG AI TV" class="eyebrow-logo" loading="lazy">
                  </picture> 
                ...
                <div class="tab-panel-banner">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-banner-desktop.png" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-banner-mobile.png" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-banner-mobile.png" alt="Above the LG Magic Remote, features such as AI Voice ID, AI Search, AI Chatbot, AI Concierge, AI Picture Wizard, and AI Sound Wizard are displayed." loading="lazy">
                  </picture>
                  <div class="text-bx">
                    <h3 class="title">
                    ...
                    <a href="https://www.lg.com/ae/tvs-soundbars/ai-tv" class="white-btn layer-open layer-tv">Learn More</a>
                  </div>
                </div>
                <!-- E : tab-panel-banner -->
                <!-- S : tab-panel-slide -->
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI Voice ID with My Profile syncs to you" data-desc="LG AI Voice ID knows each user's unique voice signature and offers personalized recommendations the moment you turn it on and speak." data-alt="On an LG OLED TV screen is the webOS 25 home page filled with apps and entertainment content. By the TV is the LG AI Magic Remote, the AI button is highlighted as if activated by the user's voice. A speech bubble is beside it, 'suggest a movie I'll like'">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature01.png" alt="On an LG OLED TV screen is the webOS 25 home page filled with apps and entertainment content. By the TV is the LG AI Magic Remote, the AI button is highlighted as if activated by the user's voice. A speech bubble is beside it, 'suggest a movie I'll like'">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="Find answers instantly with AI Search" data-desc="Voice-activated intelligence powered by built-in AI understands your inquiries. Ask questions and get tailored recommendations that meet your needs. You can also get additional results and solutions with Microsoft Copilot." data-alt="LG OLED TV screen showing how AI Search works. A small chat window is open showing how the user asked for what sports games are available. AI search responded via chat and by showing thumbnails of different available content. There is also a prompt to ask Microsoft Copilot.">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature02.png" alt="LG OLED TV screen showing how AI Search works. A small chat window is open showing how the user asked for what sports games are available. AI search responded via chat and by showing thumbnails of different available content. There is also a prompt to ask Microsoft Copilot.">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="Enjoy one-click personalized recommendations with AI Concierge " data-desc="One short press on the AI button on your remote opens up your AI Concierge which provides customized keywords and recommendations based on your search and watching history." data-alt="The LG AI Magic Remote in use. Shortly pressing the AI button activates the AI Assistant on the OLED TV screen, which then suggests keywords.">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature03.png" alt="The LG AI Magic Remote in use. Shortly pressing the AI button activates the AI Assistant on the OLED TV screen, which then suggests keywords.">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="Solve requests in real-time with AI Chatbot" data-desc="Have your own AI Chatbot actively resolve and help you with your requests. Simply speak to your TV as it can classify your intentions and respond accordingly." data-alt="Sci-fi content is playing on an LG OLED TV screen. On the left side of the screen is the AI Chatbot interface. The user messages the chatbot that the screen is too dark and the chatbot offers solutions to the request.">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature04.png" alt="Sci-fi content is playing on an LG OLED TV screen. On the left side of the screen is the AI Chatbot interface. The user messages the chatbot that the screen is too dark and the chatbot offers solutions to the request.">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="Complete your AI experience with AI Magic Remote featuring a dedicated AI button. " data-desc="Control your TV easily with AI magic remote - no extra device needed! Simple but powerful click, drag and drop functions make using webOS intuitive and easy to operate." data-alt="Woman singing into microphone with headphones, highlighted by LG α11 AI Processor sound enhancement">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature05.png" alt="Woman singing into microphone with headphones, highlighted by LG α11 AI Processor sound enhancement">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="Complete your AI experience with AI Magic Remote featuring a dedicated AI button." data-desc="Control your TV easily with AI magic remote - no extra device needed! Simple but powerful click, drag and drop functions make using webOS intuitive and easy to operate." data-alt="Two connected scenes with LG AI Magic Remote in front of a TV—first showing a sci-fi scene, second showing a home screen with personalized content">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-tv-feature06.png" alt="Two connected scenes with LG AI Magic Remote in front of a TV—first showing a sci-fi scene, second showing a home screen with personalized content">
                        </div>
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
              <div class="tab-panel-inner">
                ...
                <h2 class="tab-panel-title">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-eyebrow-logo-desktop.svg" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-eyebrow-logo-mobile.svg" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-eyebrow-logo-mobile.svg" alt="LG AI Audio" class="eyebrow-logo" loading="lazy">
                  </picture>
                ...
                <div class="tab-panel-banner">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-banner-desktop.png" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-banner-mobile.png" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-banner-mobile.png" alt="A woman and a man embrace in the living room, with the LG xboom speaker turned on beside them." loading="lazy">
                  </picture>
                  <div class="text-bx">
                    <h3 class="title">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI perfects sound for every genre" data-desc="Choose manually from rhythm, melody, or voice-oriented modes based on your preference, or let AI set the most optimal mode for you. AI analyzes audio and adjusts the sound to suit the genre." data-alt="LG xboom speaker with AI sound modes including Bass Boost, Voice Enhance, and Standard">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-feature01.png" alt="LG xboom speaker with AI sound modes including Bass Boost, Voice Enhance, and Standard">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI lighting that syncs with sound" data-desc="AI detects genre of your music and delivers the optimal the lighting that syncs with sound. Choose from Ambient, Party, Voice mode to set the mood. Check the informative lighting for speaker's status." data-alt="LG xboom speaker with AI Lighting that adapts to voice, ambient, and party modes">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-feature02.png" alt="LG xboom speaker with AI Lighting that adapts to voice, ambient, and party modes">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI calibration for space-filling sound" data-desc="AI calibrates audio based on the size and shape of the space you're in. Delivers full, undistorted sound whether in a spacious area or a small room." data-alt="LG xboom speaker placed on a table in a red-toned room with grid-patterned walls and modern furniture">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-audio-feature03.png" alt="LG xboom speaker placed on a table in a red-toned room with grid-patterned walls and modern furniture">
                        </div>
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
              <div class="tab-panel-inner">
                ...
                <h2 class="tab-panel-title">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-eyebrow-logo-desktop.svg" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-eyebrow-logo-mobile.svg" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-eyebrow-logo-desktop.svg" alt="LG AI Appliances" class="eyebrow-logo" loading="lazy">
                  </picture>
                ...
                <div class="tab-panel-banner">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-banner-desktop.png" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-banner-mobile.png" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-banner-mobile.png" alt="LG built-in stacked washer and dryer in a modern laundry room with wood cabinetry and bench seating" loading="lazy">
                  </picture>
                  <div class="text-bx">
                    <h3 class="title">
                    ...
                    <a href="https://www.lg.com/ae/lg-ai-core-tech/washing-machine-dryer" class="white-btn layer-open layer-appliances">Learn More</a>
                  </div>
                </div>
                <!-- E : tab-panel-banner -->
                <!-- S : tab-panel-slide -->
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI Wash" data-desc="AI Wash optimizes washing motions based on the laundry type. It can help achieve improved fabric care and energy savings with soft fabrics." data-alt="Hand adjusting AI Wash cycle on LG washing machine using smart control dial">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-feature01.png" alt="Hand adjusting AI Wash cycle on LG washing machine using smart control dial">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI Dry" data-desc="For 26 years, LG's washing machines have pushed the boundaries of innovation. Experience the future of laundry, where AI reaches the very core of home appliances. AI to the Core, Easy Laundry." data-alt="User selecting AI Dry cycle on LG dryer using digital control dial">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-appliances-feature02.png" alt="User selecting AI Dry cycle on LG dryer using digital control dial">
                        </div>
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
              <div class="tab-panel-inner">
                ...
                <h2 class="tab-panel-title">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-eyebrow-logo-desktop.svg" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-eyebrow-logo-mobile.svg" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-eyebrow-logo-desktop.svg" alt="LG AI Air Conditioning" class="eyebrow-logo" loading="lazy">
                  </picture>
                ...
                <div class="tab-panel-banner">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-banner-desktop.png" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-banner-mobile.png" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-banner-mobile.png" alt="The LG DUAL Inverter air conditioner cools a modern ocean-view living room, powered by ThinQ AI technology." loading="lazy">
                  </picture>
                  <div class="text-bx">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI Air" data-desc="AI Air monitors indoor temperature, humidity, and occupancy patterns to automatically adjust airflow and cooling for optimal comfort." data-alt="Woman relaxing in a smart living room while LG AI Air conditioner automatically adjusts temperature, airflow, and humidity">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature01.png" alt="Woman relaxing in a smart living room while LG AI Air conditioner automatically adjusts temperature, airflow, and humidity">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="AI kW Manager" data-desc="AI kW Manager intelligently monitors and controls electricity consumption to optimize energy efficiency and reduce utility costs." data-alt="Smartphone interface showing energy consumption graph in front of LG air conditioner, highlighting AI kW Manager for efficient power monitoring">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-feature02.png" alt="Smartphone interface showing energy consumption graph in front of LG air conditioner, highlighting AI kW Manager for efficient power monitoring">
                        </div>
            ...
            <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
              <div class="tab-panel-inner">
                ...
                <h2 class="tab-panel-title">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-eyebrow-logo-desktop.svg" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-eyebrow-logo-mobile.svg" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-eyebrow-logo-mobile.svg" alt="LG AI Computing" class="eyebrow-logo" loading="lazy">
                  </picture>
                ...
                <div class="tab-panel-banner">
                  <picture>
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-banner-desktop.png" media="(min-width: 769px)">
                    <source srcset="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-banner-mobile.png" media="(max-width: 768px)">
                    <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-banner-mobile.png" alt="A woman uses an LG gram laptop with a dual screen setup for video conferencing and multitasking in her home office." loading="lazy">
                  </picture>
                  <div class="text-bx">
                    <h3 class="title text-black">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="gram Chat On-Device" data-desc="gram Chat On-Device offers secure, offline AI assistance for file organization, search, and content summarization directly on your laptop." data-alt="LG gram laptop featuring On-Device AI with smart assistant interface on screen">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-feature01.png" alt="LG gram laptop featuring On-Device AI with smart assistant interface on screen">
                        </div>
                      ...
                      <div class="swiper-slide">
                        <div class="img-bx" data-title="gram Chat Cloud" data-desc="gram Chat Cloud leverages powerful cloud-based AI to enhance productivity with advanced content creation, research, and analysis capabilities." data-alt="LG gram laptop with Cloud AI displaying smart assistant interface for online support and productivity">
                          <img src="/ae/lg-ai/assets/image/ai-gate-image-product-category-computing-feature02.png" alt="LG gram laptop with Cloud AI displaying smart assistant interface for online support and productivity">
                        </div>
    ...
    <section class="thinq-section">
      <div class="inner">
        ...
        <a href="https://www.lg.com/ae/lg-thinq" class="white-btn">Learn More</a>
        <div class="banner">
          <picture> 
            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-thinq-banner-desktop.png" media="(min-width: 769px)">
            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-thinq-banner-mobile.png" media="(max-width: 768px)">
            <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-banner-mobile.png" alt="A person holds a smartphone with the LG ThinQ app open, managing smart home devices while drinking coffee." loading="lazy">  
          </picture>
        </div>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <button class="video-btn" type="button" data-src="TvFhuqvQLYI" aria-label="Play video">
                  <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-youtube01-thumbnail.jpg" alt="LG ThinQ ON AI voice assistant device sits on a coffee table in a smart living room, with a glowing LED ring.">
                </button>
              </div>
              <!-- E : swiper-slide01 -->
              <!-- S : swiper-slide02 -->
              <div class="swiper-slide">
                <button class="video-btn" type="button" data-src="iQyFMATSUDU" aria-label="Play video">
                  <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-youtube02-thumbnail.jpg" alt="LG ThinQ ON AI voice assistant device sits on a coffee table in a smart living room, with a glowing LED ring.">
                </button>
              </div>
              <!-- E : swiper-slide02 -->
              <!-- S : swiper-slide03 -->
              <div class="swiper-slide">
                <button class="video-btn" type="button" data-src="W6pXClCE3P4" aria-label="Play video">
                  <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-youtube03-thumbnail.jpg" alt="LG ThinQ ON AI voice assistant device sits on a coffee table in a smart living room, with a glowing LED ring.">
                </button>
              </div>
              <!-- E : swiper-slide03 -->
              <!-- S : swiper-slide04 -->
              <div class="swiper-slide">
                <button class="video-btn" type="button" data-src="oEuZqLxQrUY" aria-label="Play video">
                  <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-youtube04-thumbnail.jpg" alt="LG ThinQ ON AI voice assistant device sits on a coffee table in a smart living room, with a glowing LED ring.">
                </button>
              </div>
              <!-- E : swiper-slide04 -->
              <!-- S : swiper-slide05 -->
              <div class="swiper-slide">
                <button class="video-btn" type="button" data-src="UFRyOs-6h5s" aria-label="Play video">
                  <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-youtube05-thumbnail.jpg" alt="LG ThinQ ON AI voice assistant device sits on a coffee table in a smart living room, with a glowing LED ring.">
                </button>
              </div>
              <!-- E : swiper-slide05 -->
            </div>
        ...
        <div class="flex-bx">
          <div class="img-bx">
            <figure>
              <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-feature01.png" alt="In a modern smart kitchen, a woman uses a voice command to start the washer with LG ThinQ AI, while a man reads on the sofa in the background." loading="lazy">
            </figure>
          </div>
          <div class="text-bx">
        ...
        <div class="flex-bx reverse">
          <div class="img-bx">
            <figure>
              <img src="/ae/lg-ai/assets/image/ai-gate-image-thinq-feature02.png" alt="A smartphone displays the LG ThinQ app controlling the LG InstaView Slide-In Range oven, enabling efficient product maintenance in the kitchen." loading="lazy">
            </figure>
          </div>
          <div class="text-bx">
              ...
              <div class="swiper" role="region" aria-label="스토리 슬라이드쇼">
                  <div class="swiper-wrapper">
                      <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                          <picture>
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner01-desktop.png" media="(min-width: 769px)">
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner01-desktop.png" media="(max-width: 768px)">
                            <img src="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner01-mobile.png" alt="LG Electronics executive holding certificate of accreditation for cybersecurity, with digital security graphic in background" loading="lazy">
                          </picture>
                          <div class="txt-bx">
                      ...
                      <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                          <picture>
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner02-desktop.png" media="(min-width: 769px)">
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner02-mobile.png" media="(max-width: 768px)">
                            <img src="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner02-mobile.png" alt="Visitors viewing LG curved LED display showcasing 'Life's Good 24/7' slogan at tech exhibition" loading="lazy">
                          </picture>
                          <div class="txt-bx">
                      ...
                      <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                          <picture>
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner03-desktop.png" media="(min-width: 769px)">
                            <source srcset="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner03-mobile.png" media="(max-width: 768px)">
                            <img src="/ae/lg-ai/assets/image/ai-gate-image-more-about-ai-banner03-mobile.png" alt="Speaker presenting AI-powered B2B solutions on stage at LG event" loading="lazy">
                          </picture>
                          <div class="txt-bx">
