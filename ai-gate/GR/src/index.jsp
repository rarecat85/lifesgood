...
και τη φράση: «Affectionate Intelligence για εσένα»</h1>
        ...
        <section class="overview-section">
          <div class="inner">
            ...
            <h2 class="title" data-tp="copy"><span class="gradient-text" data-tp="copy">Affectionate Intelligence</span> για ΕΣΕΝΑ</h2>
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">Η LG AI καταλαβαίνει την καθημερινόηττα σας και την αναβαθμίζει, γεμίζοντάς την με ευχάριστες στιγμές.</h2>
                    <!-- S : video-bx -->
