...
镜头聚焦于他们身旁的LG XBOOM音响。</span>
                    ...
                    <ul class="product-list">
                      ...
                      <li class="product-item">
                        <a href="https://www.lg.com/cn/monitors/lg-32g810sa-w" data-tp="link">
                          <div class="img-bx">
                            <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products02.png" alt="LG MNT 智能 AI 产品正面视图" loading="lazy" data-tp="alt">
                          </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">认识新一代<br>
                          LG AI电视</h3>
        ...
        <section class="thinq-section">
          <div class="inner">
            <h2 class="thinq-section-title" data-tp="copy">LG ThinQ 打造智能的生活方式</h2>
