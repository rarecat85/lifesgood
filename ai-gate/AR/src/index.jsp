          ...
          <div class="inner">
            <div class="tab-container" role="tablist">
              ...
              <div class="tab-list">
                ...
                <button class="tab" role="tab" aria-selected="false" aria-controls="feature-panel-3" id="feature-tab-3" data-tp="copy">Lavado</button>
...
A su lado aparece un globo de diálogo: “Sugerime una peli que me guste”" data-tp="alt">
                            ...
                            <p class="slide-title" data-tp="copy">                            <p class="slide-title" data-tp="copy">Reconocimiento de voz con IA</p>
                          </p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
...
El usuario le escribe al chatbot que la pantalla está demasiado oscura, y el chatbot le ofrece soluciones para resolverlo." data-tp="alt">
                          ...
                          <div class="swiper-slide">
                            ...
                            <p class="slide-title" data-tp="copy">Ajuste de imagen y sonido con IA</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
...
Te pone el control y la comodidad al alcance de la mano, para ayudarte a simplificar tu vida y disfrutar del confort del hogar.</p>
            ...
            <div class="flex-bx">
              ...
              <div class="text-bx">
                ...
                <p class="text" data-tp="copy">Decile a tu electrodoméstico LG exactamente lo que querés, y el parlante con IA escuchará y verificará lo que necesitás.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
            <!-- S : thinq-flex-bx -->
            <div class="flex-bx reverse">
              ...
              <div class="text-bx">
                ...
                <p class="text" data-tp="copy">A través de la app LG ThinQ, controlá tu electrodoméstico LG, descargá nuevos ciclos de lavado, monitoreá el uso de tus equipos, y mucho más.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
          </div>
