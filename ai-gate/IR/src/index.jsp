                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-1" id="feature-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title" data-tp="copy">با نسل با نسل جدید<br>تلویزیون‌های هوش مصنوعی<br>ال‌جی آشنا شوید.</h3>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        <h3 class="title text-black" data-tp="copy">توانایی‌های جدیدت را کشف کن 
                          بدون<br> محدودیت با هوش مصنوعی LG Gram</h3>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
