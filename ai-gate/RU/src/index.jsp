...
<head>
    ...
    <meta property="og:description" content="LG AI стремится к тому, чтобы ваша жизнь была приятнее, без усилий и заботы, благодаря «разумному восприятию, глубокому пониманию, теплой заботе». Ощутите более высокое качество жизни с LG Affectionate Intelligence, где искусственный интеллект выходит за рамки обычного искусственного интеллекта и обеспечивает теплую заботу, ориентированную на человека."/>
...
<div class="sr-only" itemscope itemtype="http://schema.org/WebPage">
    ...
    <meta itemprop="description" content="LG AI стремится к тому, чтобы ваша жизнь была приятнее, без усилий и заботы, благодаря «разумному восприятию, глубокому пониманию, теплой заботе». Ощутите более высокое качество жизни с LG Affectionate Intelligence, где искусственный интеллект выходит за рамки обычного искусственного интеллекта и обеспечивает теплую заботу, ориентированную на человека."/>
    <meta itemprop="Keywords" content=" LG AI, Affectionate Intelligence, Человеко-ориентированный ИИ, Платформа для умной жизни, Передовые технологические решения"/>
</div>
...
Финальный кадр: белый фон с логотипом LG AI и надписью «Заботливый интеллект для ВАС».</h1>
        ...
        <section class="overview-section">
          <div class="inner">
            ...
            <h2 class="title" data-tp="copy"><span class="gradient-text" data-tp="copy">Заботливый интеллект</span> для вас</h2>
            <p class="text" data-tp="copy">Мы в LG задали себе вопрос: для чего должен существовать AI, искусственный интеллект? <br>
            ...
            <div class="tab-container" role="tablist">
              ...
              <div class="panel-container">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-1" id="product-panel-1">
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      ...
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products02.png" alt="Телевизор LG OLED AI вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                      ...
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products04.png" alt="Телевизор LG NanoCell AI product вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit01-products05.png" alt="Портативная колонка LG xboom AI product вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                    </ul>
                    <!-- E : product-list -->
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden="">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI понимает ваши потребности и предлагает решения, чтобы жизнь протекала легко и гармонично, в вашем собственном ритме.</h2>
                    <!-- S : video-bx -->
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products01.png" alt="LG WashTower AI стиральная и сушильная машина, вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                      ...
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit02-products03.png" alt="Сушильная машина LG Dryer AI, вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden="">
                  <div class="tab-panel-inner">
                    <h2 class="tab-panel-title text-center" data-tp="copy">LG AI заботится о вас, вашем пространстве и планете, делая жизнь комфортнее.</h2>
                    <!-- S : video-bx -->
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./lg-ai/assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI, вид спереди" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
          ...
          <div class="inner">
            <div class="tab-container" role="tablist">
              ...
              <div class="tab-list">
                ...
                <button class="tab" role="tab" aria-selected="false" aria-controls="feature-panel-5" id="feature-tab-5" data-tp="copy">Компьютеры</button>
              </div>
              <!-- E : tab-list -->
              <!-- S : panel-container -->
              <div class="panel-container">
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        ...
                        <a href="https://www.lg.com/de/tvs-und-soundbars/ai-tv/" class="white-btn" data-tp="copy link">Узнать больше</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                      ...
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            ...
                            <p class="slide-title" data-tp="copy">Пульт AI Magic Remote</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-2" id="feature-panel-2">
                  <div class="tab-panel-inner">
                    ...
                    <h2 class="tab-panel-title" data-tp="copy"><picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-audio-eyebrow-logo-mobile.svg" alt="Аудио LG AI" class="eyebrow-logo" loading="lazy">
                      </picture>
                      Звучит абсолютно правильно</h2>
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG XBOOM AI анализирует и настраивает звук в зависимости от жанра и пространства. Благодаря умной подсветке, которая создаёт атмосферу и синхронизируется с вашей музыкой, вы получаете уникальное сочетание звука и настроения.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">* Продукт еще не доступен</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-3" id="feature-panel-3">
                  <div class="tab-panel-inner">
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">* Этот продукт будет постепенно выпускаться в отдельных странах.</li>
                      <li data-tp="copy">** AI-распознавание активируется при загрузке до 6 кг.</li>
                      <li data-tp="copy">*** Режим AI Wash следует использовать только для тканей одного типа [распознаются не все ткани] и с подходящим моющим средством.</li>
                      <li data-tp="copy">**** Функция AI Dry доступна только для загрузки до 5 кг с тканями, имеющими одинаковый уровень впитываемости влаги.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-4" id="feature-panel-4">
                  <div class="tab-panel-inner">
                    ...
                    <h2 class="tab-panel-title" data-tp="copy"><picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-air-conditioning-eyebrow-logo-mobile.svg" alt="Кондиционеры воздуха LG AI" class="eyebrow-logo" loading="lazy">
                      </picture>
                      Созданы для комфортного охлаждения</h2>
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG DUALCOOL AI поддерживает идеальный микроклимат и обеспечивает комфортные условия и энергоэффективность, помогая экономить деньги. С LG AI Air вы получаете идеальное охлаждение и максимальное удобство.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <ul class="tab-panel-disclaimer">
                      ...
                      <li data-tp="copy">**** При активации AI Air радарный датчик определяет местоположение человека и автоматически настраивает прямой или непрямой воздушный поток.</li>
                      <li data-tp="copy">***** Дальность обнаружения радарного датчика — до 5 м, однако она может варьироваться в зависимости от условий установки и эксплуатации.</li>
                      <li data-tp="copy">****** Эта функция доступна только в моделях, оснащенных радарными датчиками.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="feature-tab-5" id="feature-panel-5">
                  <div class="tab-panel-inner">
                    ...
                    <h2 class="tab-panel-title" data-tp="copy"><picture>
                        ...
                        <img src="./lg-ai/assets/image/ai-gate-image-product-category-computing-eyebrow-logo-mobile.svg" alt="Компьютеры LG AI" class="eyebrow-logo" loading="lazy">  
                      </picture>
                      Дают энергию всему, что вы делаете</h2>
                    <!-- E : tab-panel-title -->
                    <!-- S : tab-panel-text -->
                    <p class="tab-panel-text" data-tp="copy">LG gram AI улучшает вашу работу как в интернете, так и офлайн. Безопасно находите и обрабатывайте файлы офлайн с помощью gram chat на устройстве, а для повышения продуктивности онлайн используйте облачный gram chat, поддерживаемый GPT-4o.</p>
                    <!-- E : tab-panel-text -->
                    <!-- S : tab-panel-banner -->
                    <div class="tab-panel-banner">
                      <picture>
                    ...
                    <!-- S : tab-panel-disclaimer -->
                    <ul class="tab-panel-disclaimer">
                      <li data-tp="copy">* На начальных этапах использования продукта некоторые функции могут работать не совсем гладко. Это связано с особенностями искусственного интеллекта, встроенного в устройство, который требует времени на предварительное обучение, чтобы адаптироваться к пользователю.</li>
                      <li data-tp="copy">* gram Chat On-Device требует индексирования задач для поиска контента на вашем ПК, объединяя слова с данными, что может занять некоторое время для получения желаемых результатов.</li>
                    </ul>
                    <!-- E : tab-panel-disclaimer -->
                  </div>
                </div>
        ...
        <section class="thinq-section">
          <div class="inner">
            <h2 class="thinq-section-title" data-tp="copy">ThinQ® помогает создавать комфортную жизнь</h2>
            <p class="thinq-section-text" data-tp="copy">ThinQ — это платформа для ваших умных устройств LG, которая обеспечивает удобство управления, помогая упростить жизнь и наслаждаться комфортом дома.</p>
            ...
            <div class="flex-bx">
              ...
              <div class="text-bx">
                ...
                <p class="text" data-tp="copy">Просто скажите, что вам нужно, и AI-колонка услышит вас, проверит информацию и сообщит результат.</p>
              </div>
            </div>
            <!-- E : thinq-flex-bx -->
            <!-- S : thinq-flex-bx -->
            <div class="flex-bx reverse">
              ...
              <div class="text-bx">
                <h3 class="title" data-tp="copy">Эффективное сервисное обслуживание</h3>
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-strengthens-cybersecurity-leadership-with-kolas-iot-cybersecurity-testing-accreditation/" class="white-btn" data-tp="copy link">Узнать больше</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-presents-its-latest-innovations-powered-by-affectionate-intelligence-at-ces-2025/" class="white-btn" data-tp="copy link">Узнать больше</a>
                              </div>
                          </div>
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                              ...
                              <div class="txt-bx">
                                  ...
                                  <a href="https://www.lgnewsroom.com/2025/01/lg-unveils-a-day-in-a-life-with-affectionate-intelligence-at-lg-world-premiere/" class="white-btn" data-tp="copy link">Узнать больше</a>
                              </div>
                          </div>
                      </div>
                  </div>
