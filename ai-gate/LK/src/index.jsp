...
<head>
    ...
    <title>LG Affectionate Intelligence | LG LK</title>
    ...
    <meta property="og:title" content="LG Affectionate Intelligence | LG LK"/>
    <meta property="og:url" content="https://www.lg.com/lk/lg-ai">
      ...
      <div class="gate-container">
              ...
              <div class="panel-container">
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/lk/oled-tvs">
                          <div class="img-bx">
                      ...
                      <li class="product-item">
                        <a href="https://www.lg.com/lk/qned-tvs">
                          <div class="img-bx">
                      ...
                      <li class="product-item">
                        <a href="https://www.lg.com/lk/nanocell-tvs">
                          <div class="img-bx">
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden>
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <a href="https://www.lg.com/lk/washing-machines/lg-fv1413s2ba">
                          <div class="img-bx">
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        ...
                        <a href="https://www.lg.com/lk/tvs-soundbars/ai-tv" class="white-btn">Learn More</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      ...
                      <div class="text-bx">
                        ...
                        <a href="https://www.lg.com/global/lg-ai-core-tech/washing-machine-dryer/" class="white-btn ">Learn More</a>
                      </div>
                    </div>
                    <!-- E : tab-panel-banner -->
                    <!-- S : tab-panel-slide -->
        ...
        <section class="thinq-section">
          <div class="inner">
            ...
            <a href="https://www.lg.com/lk/appliances/thinq" class="white-btn">Learn More</a>
            <div class="banner">
              <picture> 
