        ...
        <section class="overview-section">
          <div class="inner">
            <picture>
              ...
              <img src="./assets/image/ai-gate-image-overview-ai-logo-mobile.svg" alt="LG AI лого" class="ai-logo" data-tp="alt">
            </picture>
            ...
            <img src="./assets/image/ai-gate-image-overview-scroll-down-icon-desktop.svg" alt="Иконка вниз" class="scroll-down-icon" data-tp="alt">
          </div>
        </section>
        <!-- E : overview-section -->
        <!-- S : product-section -->
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit01-products01.png" alt="LG OLED evo AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit01-products02.png" alt="LG OLED AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit01-products03.png" alt="LG QNED AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit01-products04.png" alt="LG NanoCell AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit01-products05.png" alt="LG XBOOM AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                    </ul>
                    <!-- E : product-list -->
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-2" id="product-panel-2" hidden="">
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit02-products01.png" alt="LG WashTower A — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit02-products02.png" alt="LG Washing Machine — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit02-products03.png" alt="LG Dryer AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit02-products04.png" alt="LG InstaView AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit02-products05.png" alt="LG gramPro AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                    </ul>
                    <!-- E : product-list -->
                ...
                <div class="tab-panel" role="tabpanel" aria-labelledby="product-tab-3" id="product-panel-3" hidden="">
                  <div class="tab-panel-inner">
                    ...
                    <ul class="product-list">
                      <li class="product-item">
                        <div class="img-bx">
                          <img src="./assets/image/ai-gate-image-benefit03-products01.png" alt="LG DUALCOOL AI — передний вид" loading="lazy" data-tp="alt">
                        </div>
                      </li>
                      <li class="product-item">
                        <a href="https://www.lg.com/global/mobility/mobility-labworks-series/adas-solutions/in-cabin-vision" data-tp="link">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit03-products02.png" alt="ADAS vision system — передний вид" loading="lazy" data-tp="alt">
                          </div>
                      ...
                      <li class="product-item">
                        <a href="https://www.lg.com/global/mobility/mobility-labworks-series/digital-cockpit-solutions/digital-cockpit-gamma" data-tp="link">
                          <div class="img-bx">
                            <img src="./assets/image/ai-gate-image-benefit03-products03.png" alt="Пользователь взаимодействует с сенсорным интерфейсом на базе мультимодального ИИ HMI, выбирая меню кофе с подсказкой от помощника" loading="lazy" data-tp="alt">
                          </div>
                          <span class="link-btn" data-tp="copy">Подробнее</span>
                        </a>
                      </li>
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-tv-banner-mobile.png" alt="Над LG Magic Remote отображаются функции: AI Voice ID, AI Search, AI Chatbot, AI Concierge, AI Picture Wizard и AI Sound Wizard." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                      ...
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature01.png" alt="На экране LG OLED TV отображается домашняя страница webOS 25 с приложениями и развлекательным контентом. Рядом — пульт LG AI Magic Remote, кнопка AI подсвечена, будто активирована голосом. Рядом облачко с фразой: «предложи фильм, который мне понравится»." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Voice ID</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature02.png" alt="На экране LG OLED TV показано, как работает AI Search. Открыто чат-окно, где пользователь спрашивает о доступных спортивных играх. AI Search отвечает в чате и показывает миниатюры контента. Также отображается подсказка — задать вопрос Microsoft Copilot." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Search</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature03.png" alt="Пульт LG AI Magic Remote в использовании. Короткое нажатие кнопки AI активирует ассистента на экране OLED TV, он предлагает ключевые слова." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Concierge</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature04.png" alt="На экране LG OLED TV воспроизводится научно-фантастический контент. Слева отображается интерфейс AI Чат-бота. Пользователь пишет, что экран слишком тёмный, и чат-бот предлагает варианты решения." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Chatbot</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature05.png" alt="Женщина поёт в микрофон в наушниках, звук подчёркнут улучшением LG α11 AI Processor." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Picture/Sound Wizard</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-tv-feature06.png" alt="Две связанные сцены с LG AI Magic Remote перед телевизором: сначала — кадр из фантастики, затем — главный экран с персонализированным контентом." data-tp="alt">
                            </div>
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-audio-banner-mobile.png" alt="Мужчина и женщина обнимаются в гостиной, рядом с ними включена колонка XBOOM." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-audio-feature01.png" alt="Колонка LG XBOOM с режимами AI-звука: Bass Boost, Voice Enhance и Standard." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Sound</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-audio-feature02.png" alt="Колонка LG XBOOM с AI-подсветкой, которая меняется под голос, свет и вечеринку." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Lighting</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-audio-feature03.png" alt="Колонка LG XBOOM стоит на столе в комнате с красным тоном, сетчатыми стенами и современной мебелью." data-tp="alt">
                            </div>
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-appliances-banner-mobile.png" alt="Стиральная и сушильная машины LG, установленные друг над другом в прачечной с деревом и скамьёй." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-appliances-feature01.png" alt="Рука настраивает AI Wash на стиральной машине LG с помощью умного диска." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Wash</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-appliances-feature02.png" alt="Пользователь выбирает AI Dry на сушилке LG через цифровой диск." data-tp="alt">
                            </div>
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-air-conditioning-banner-mobile.png" alt="Кондиционер LG DUAL Inverter охлаждает современную гостиную, где женщина сидит на диване, управляемый технологией ThinQ AI." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-air-conditioning-feature01.png" alt="Женщина отдыхает в гостиной, в то время как кондиционер LG AI автоматически регулирует температуру, воздух и влажность." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">AI Air</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-air-conditioning-feature02.png" alt="На смартфоне отображён график потребления энергии рядом с кондиционером LG, акцент на AI kW Manager для эффективного контроля энергии." data-tp="alt">
                            </div>
                  ...
                  <div class="tab-panel-inner">
                    ...
                    <div class="tab-panel-banner">
                      <picture>
                        ...
                        <img src="./assets/image/ai-gate-image-product-category-computing-banner-mobile.png" alt="Женщина использует ноутбук LG gram с двумя экранами для видеоконференций и многозадачности в домашнем офисе." loading="lazy" data-tp="alt">
                      </picture>
                      <div class="text-bx">
                    ...
                    <div class="tab-panel-slide">
                      <div class="swiper products-textbx-thumbbx">
                        ...
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-computing-feature01.png" alt="Ноутбук LG gram с On-Device AI и интерфейсом умного ассистента на экране." data-tp="alt">
                            </div>
                            <p class="slide-title" data-tp="copy">gram Chat On-Device</p>
                          </div>
                          <div class="swiper-slide">
                            <div class="img-bx">
                              <img src="./assets/image/ai-gate-image-product-category-computing-feature02.png" alt="Ноутбук LG gram с Cloud AI и интерфейсом умного ассистента для поддержки и продуктивности онлайн." data-tp="alt">
                            </div>
          ...
          <div class="inner">
            ...
            <div class="banner">
              <picture> 
                ...
                <img src="./assets/image/ai-gate-image-thinq-banner-mobile.png" alt="Человек держит смартфон с открытым приложением LG ThinQ, управляя умными устройствами дома, пья кофе." loading="lazy" data-tp="alt">  
              </picture>
            </div>
            ...
            <div class="flex-bx">
              <div class="img-bx">
                <figure>
                  <img src="./assets/image/ai-gate-image-thinq-feature01.png" alt="В современной умной кухне женщина использует голосовую команду для запуска стиральной машины с LG ThinQ AI, а мужчина читает на диване на фоне" loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
            ...
            <div class="flex-bx reverse">
              <div class="img-bx">
                <figure>
                  <img src="./assets/image/ai-gate-image-thinq-feature02.png" alt="Смартфон отображает приложение LG ThinQ, управляющее духовым шкафом LG InstaView Slide-In Range, обеспечивая эффективное обслуживание в кухне." loading="lazy" data-tp="alt">
                </figure>
              </div>
              <div class="text-bx">
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./assets/image/ai-gate-image-more-about-lg-ai-banner01-mobile.png" alt="Руководитель LG Electronics с сертификатом аккредитации по кибербезопасности на фоне графики цифровой безопасности." loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                          ...
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./assets/image/ai-gate-image-more-about-lg-ai-banner02-mobile.png" alt="Посетители на техно-выставке смотрят на изогнутый LED экран LG с &quot;Life's Good 24/7&quot;." loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
                          ...
                          <div class="swiper-slide" role="group" aria-roledescription="슬라이드">
                              <picture>
                                ...
                                <img src="./assets/image/ai-gate-image-more-about-lg-ai-banner03-mobile.png" alt="Докладчик представляет AI-решения B2B на мероприятии LG." loading="lazy" data-tp="alt">
                              </picture>
                              <div class="txt-bx">
